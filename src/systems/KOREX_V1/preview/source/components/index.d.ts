...
export interface ButtonProps { variant?: 'primary' | 'secondary' | 'ghost' | 'danger'; size?: 'sm' | 'md' | 'lg'; state?: Forced3; icon?: IconName; iconEnd?: IconName; iconOnly?: boolean; label?: string; loading?: boolean; loadingLabel?: React.ReactNode; disabled?: boolean; block?: boolean; href?: string; type?: 'button' | 'submit'; onClick?: React.MouseEventHandler; children?: React.ReactNode; className?: string }
export declare function Button(props: ButtonProps): React.ReactElement;
interface FieldBase { label: React.ReactNode; description?: React.ReactNode; error?: React.ReactNode; success?: React.ReactNode; required?: boolean; readOnly?: boolean; disabled?: boolean; state?: 'focus'; id?: string; className?: string }
...
export interface BadgeProps { tone?: 'neutral' | 'brand' | 'success' | 'warning' | 'error'; size?: 'sm' | 'md'; icon?: IconName | false; children: React.ReactNode; className?: string }
...
export interface SkeletonProps { variant?: 'text' | 'media' | 'block'; lines?: number; size?: 'title' | 'display'; width?: string | number; height?: number; tall?: boolean; label?: string; silent?: boolean; className?: string }
export declare function Skeleton(props: SkeletonProps): React.ReactElement;
export interface IconProps { name: IconName; size?: 16 | 20 | 24 | number; label?: string; className?: string }
export declare function Icon(props: IconProps): React.ReactElement;
export interface DialogProps { open: boolean; onClose?: () => void; title: React.ReactNode; description?: React.ReactNode; size?: 'sm' | 'md' | 'lg'; children?: React.ReactNode; footer?: React.ReactNode; dismissible?: boolean; hideClose?: boolean; closeLabel?: string; contained?: boolean; role?: 'dialog' | 'alertdialog'; className?: string }
export declare function Dialog(props: DialogProps): React.ReactElement | null;
export interface AlertDialogProps { open: boolean; title: React.ReactNode; description?: React.ReactNode; tone?: 'danger' | 'neutral'; confirmLabel?: React.ReactNode; cancelLabel?: React.ReactNode; onConfirm?: () => void; onCancel?: () => void; loading?: boolean; loadingLabel?: React.ReactNode; error?: React.ReactNode; contained?: boolean; className?: string }
export declare function AlertDialog(props: AlertDialogProps): React.ReactElement | null;
export interface MenuItem { label?: React.ReactNode; value?: string; icon?: IconName; description?: React.ReactNode; selected?: boolean; disabled?: boolean; disabledReason?: string; danger?: boolean; divider?: boolean; state?: 'hover' | 'focus' }
...
export interface TableColumn { key: string; label: React.ReactNode; sortable?: boolean; align?: 'start' | 'end'; width?: string | number; truncate?: boolean; render?: (value: any, row: any) => React.ReactNode }
export interface TableProps { columns: TableColumn[]; rows: Record<string, any>[]; rowKey?: string; sort?: { key: string; dir: 'asc' | 'desc' }; defaultSort?: { key: string; dir: 'asc' | 'desc' }; onSortChange?: (s: { key: string; dir: 'asc' | 'desc' }) => void; state?: 'loading' | 'empty' | 'error'; loadingRows?: number; emptyTitle?: React.ReactNode; emptyText?: React.ReactNode; emptyAction?: React.ReactNode; errorTitle?: React.ReactNode; errorText?: React.ReactNode; onRetry?: () => void; retryLabel?: string; caption?: string; captionHidden?: boolean; minWidth?: number; selectedKey?: string; className?: string }
export declare function Table(props: TableProps): React.ReactElement;
export interface PaginationProps { total: number; page?: number; defaultPage?: number; onChange?: (page: number) => void; disabled?: boolean; prevLabel?: string; nextLabel?: string; label?: string; className?: string }
export declare function Pagination(props: PaginationProps): React.ReactElement;
export interface ToastProps { tone?: 'info' | 'success' | 'warning' | 'error'; title?: React.ReactNode; children?: React.ReactNode; action?: React.ReactNode; onClose?: () => void; closeLabel?: string; inline?: boolean; toneLabel?: string; className?: string }
...
declare global {
  interface Window {
    KOREX: {
      ...
      Pagination: typeof Pagination; Toast: typeof Toast; AlertDialog: typeof AlertDialog; ICON_NAMES: IconName[];
    };
  }
}
