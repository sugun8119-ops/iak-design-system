...
자체 제작 선 아이콘 20종: 20×20 그리드, 1.5px 선, 각진 끝(square cap), `currentColor`. 크기 16 · 20 · 24.

- **출처**: **derived-extension**. KOREX 원본에는 아이콘 세트가 없고 텍스트 화살표 “↗”만 있었다. 각진 CTA 성격에 맞게 둥근 끝 대신 square cap을 쓴다. 외부 아이콘 라이브러리나 IAK 로고는 쓰지 않는다.
