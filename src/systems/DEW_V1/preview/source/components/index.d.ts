...
/** v1.3: an unknown `name` renders an explicit dashed 'unresolved' marker (data-unresolved), never a substitute glyph. */
export interface IconProps { name: IconName | string; size?: 16 | 20 | 24; tone?: 'accent' | 'muted'; label?: string; spin?: boolean; className?: string }
...
export interface BadgeProps { tone?: 'neutral' | 'info' | 'success' | 'warning' | 'danger' | 'error'; /** v1.3 numeric badge */ count?: number; max?: number; srLabel?: string; icon?: IconName | null; label?: React.ReactNode; children?: React.ReactNode; className?: string }
...
export interface SkeletonProps { variant?: 'text' | 'heading' | 'circle' | 'media' | 'story' | 'feature' | 'row' | 'block'; /** circle diameter (v1.3) */ size?: number; lines?: number; cells?: number; ratio?: 'portrait' | 'wide'; width?: string | number; height?: string | number; label?: string; decorative?: boolean; className?: string }
export declare function Skeleton(props: SkeletonProps): React.ReactElement;
export interface DialogProps { open: boolean; onClose?: () => void; title: React.ReactNode; eyebrow?: React.ReactNode; description?: React.ReactNode; children?: React.ReactNode; footer?: React.ReactNode; size?: 'sm' | 'md' | 'lg'; icon?: IconName; tone?: 'danger'; dismissable?: boolean; closable?: boolean; role?: 'dialog' | 'alertdialog'; inline?: boolean; /** v1.3: bound the panel; body scrolls and becomes a focusable region */ maxHeight?: number | string; closeState?: 'focus' | 'hover'; busy?: boolean; className?: string }
export declare function Dialog(props: DialogProps): React.ReactElement | null;
export interface AlertDialogProps { open: boolean; title: React.ReactNode; description?: React.ReactNode; confirmLabel?: React.ReactNode; cancelLabel?: React.ReactNode; /** v1.3: may return a Promise — pending/error/retry are then managed internally */ onConfirm?: () => void | Promise<unknown>; onResolved?: (value: unknown) => void; onCancel?: () => void; tone?: 'danger' | 'default'; loading?: boolean; loadingLabel?: React.ReactNode; /** derived-extension: failure message; switches confirm to a retry button */ error?: React.ReactNode; errorTitle?: React.ReactNode; retryLabel?: React.ReactNode; onRetry?: () => void | Promise<unknown>; eyebrow?: React.ReactNode; children?: React.ReactNode; inline?: boolean }
export declare function AlertDialog(props: AlertDialogProps): React.ReactElement | null;
export interface MenuItem { label?: React.ReactNode; description?: React.ReactNode; icon?: IconName; selected?: boolean; disabled?: boolean; disabledReason?: React.ReactNode; danger?: boolean; separator?: boolean; /** v1.3: renders <a role="menuitem" href> */ href?: string; onSelect?: (item: MenuItem) => void; state?: 'hover' | 'highlighted' | 'focus' }
