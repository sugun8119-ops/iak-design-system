/* @ds-bundle: {"format":4,"namespace":"RAISDesignSystem_019e07","components":[{"name":"AlertDialog","sourcePath":"zem/components/AlertDialog.jsx"},{"name":"Badge","sourcePath":"zem/components/Badge.jsx"},{"name":"Button","sourcePath":"zem/components/Button.jsx"},{"name":"Card","sourcePath":"zem/components/Card.jsx"},{"name":"Checkbox","sourcePath":"zem/components/Checkbox.jsx"},{"name":"Dialog","sourcePath":"zem/components/Dialog.jsx"},{"name":"Icon","sourcePath":"zem/components/Icon.jsx"},{"name":"Menu","sourcePath":"zem/components/Menu.jsx"},{"name":"Pagination","sourcePath":"zem/components/Pagination.jsx"},{"name":"Select","sourcePath":"zem/components/Select.jsx"},{"name":"Skeleton","sourcePath":"zem/components/Skeleton.jsx"},{"name":"Switch","sourcePath":"zem/components/Switch.jsx"},{"name":"Table","sourcePath":"zem/components/Table.jsx"},{"name":"TextField","sourcePath":"zem/components/TextField.jsx"},{"name":"Textarea","sourcePath":"zem/components/Textarea.jsx"},{"name":"Toast","sourcePath":"zem/components/Toast.jsx"},{"name":"ToastProvider","sourcePath":"zem/components/Toast.jsx"}],"sourceHashes":{"archive/iak/master/lib/card.js":"a770251d6898","archive/iak/master/lib/iak-ui.js":"857deadf8315","archive/iak/master/lib/icons.js":"2389487dca34","archive/iak/master/lib/patterns.js":"bd000d5ed4e0","archive/iak/ui_kits/rais-dashboard/Components.jsx":"fc2ced315ee7","archive/iak/ui_kits/rais-dashboard/Sidebar.jsx":"98e51da1e403","archive/iak/ui_kits/rais-dashboard/TopBar.jsx":"da2db3676a27","zem/components/AlertDialog.jsx":"fdc4330b59b0","zem/components/Badge.jsx":"850a962886c7","zem/components/Button.jsx":"6ec0bdc06702","zem/components/Card.jsx":"0f0112c6aa42","zem/components/Checkbox.jsx":"827c4f9844c7","zem/components/Dialog.jsx":"d3c1228659c9","zem/components/Icon.jsx":"d73883c8e75a","zem/components/Menu.jsx":"ca33c0f1dd15","zem/components/Pagination.jsx":"1712d05377e8","zem/components/Select.jsx":"9d9a8560583f","zem/components/Skeleton.jsx":"4c530da1f2a7","zem/components/Switch.jsx":"abb56e34c54d","zem/components/Table.jsx":"7855a10fe3ce","zem/components/TextField.jsx":"919f342162db","zem/components/Textarea.jsx":"fce48f2c5387","zem/components/Toast.jsx":"8f9e54fad2c2","zem/lib/card.js":"70f8fc06a390","zem/lib/contrast.js":"776b4a8729e0","zem/lib/icons.js":"9236334bd3cd","zem/lib/patterns.js":"ee525ab8bc17","zem/lib/zem-ui.js":"17d13114d1d8","zem/ui_kits/kits.js":"0dadde80932d"},"inlinedExternals":[],"unexposedExports":[{"name":"useToast","sourcePath":"zem/components/Toast.jsx"}]} */
...
try { (() => {
// AlertDialog — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// Card — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
function Card(props) {
...
try { (() => {
// Checkbox — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// Dialog — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// Icon — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
function Icon(props) {
...
try { (() => {
// Skeleton — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// Switch — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// Table — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// TextField — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// Textarea — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
try { (() => {
// Toast — thin export of the ZEM_V1 UI (zem/lib/zem-ui.js). Requires zem/lib/icons.js for glyphs.
...
(function () {
  ...
  function Page({
    ...
    return h('main', {
      ...
      className: 'ov'
    }, spec.group || 'ZEM · Component'), h('h1', null, spec.name), spec.description && h('p', null, spec.description), h('div', {
      className: 'mc-meta'
    }, (spec.meta || []).map((m, i) => h('code', {
      key: i
    }, m)))), spec.sections.map((s, i) => h('section', {
...
// zem/lib/patterns.js
try { (() => {
/* ZEM_V1 · 10 patterns — ZEM-style DERIVED extensions (not claimed to exist in the source). Fictional, self-written sample data only. */
(function () {
  const h = React.createElement,
    F = React.Fragment;
  const {
  ...
  /* ---------- charts (progress/data role = periwinkle) ---------- */
  function Bars({
    data,
    labels,
    height = 160,
    ...
    return h('svg', {
      ...
      return h('g', {
        ...
        height: bh,
        rx: 10,
        fill: over ? 'var(--zem-periwinkle-300)' : 'var(--zem-periwinkle-500)'
      }), h('text', {
        x: i * bw + bw / 2,
        y: H + 18,
        textAnchor: 'middle',
  ...
  S.dashboard = {
    ...
    render(s) {
      return h(Shell, {
        ...
        title: '이번 주 사용 (분)',
        footer: Legend([['var(--zem-periwinkle-500)', '목표 이내'], ['var(--zem-periwinkle-300)', '목표 초과'], ['var(--zem-coral-600)', '목표 90분']])
      }, h(Bars, {
        data: usage,
        labels: days,
        line: goal,
  ...
  window.ZEM_mountPattern = function (el, p, s) {
    const def = S[p] || S.dashboard;
    const st = def.states.includes(s) ? s : def.states[0];
    document.title = 'ZEM_V1 · ' + def.label + ' · ' + st;
    ReactDOM.createRoot(el).render(h(() => def.render(st)));
    return {
      p: S[p] ? p : 'dashboard',
      s: st
...
// zem/lib/zem-ui.js
try { (() => {
/* ZEM_V1 UI · same component API as the IAK Master port (archive/iak/master/lib/iak-ui.js); ZEM styling in zem-ui.css. Overlay behaviour is a dependency-free approximation for previews. Preview-only props: inline, previewState, ToastView. */
(function () {
  const h = React.createElement,
    IC = () => window.ZEM_ICONS || {};
  const cx = (...a) => a.filter(Boolean).join(' ');
...
(function () {
  ...
  function Schedule() {
    ...
    return h(Shell, {
      ...
      key: d,
      style: {
        background: cell(di, si).length ? TONE[cell(di, si)[0].k] : 'var(--zem-periwinkle-50)',
        fontWeight: 700,
  ...
  function Activity() {
    ...
    if (p === 'analytics') return h(Shell, {
      ...
      title: '요일별 미션 완료',
      footer: Legend([['var(--zem-periwinkle-500)', '완료 개수']])
    }, h(Bars, {
      data: [2, 1, 3, 2, 1, 2, 1],
