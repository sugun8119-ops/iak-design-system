/* @ds-bundle: {"format":4,"namespace":"RAISDesignSystem_019e07","components":[{"name":"AlertDialog","sourcePath":"dew/components/AlertDialog.jsx"},{"name":"Badge","sourcePath":"dew/components/Badge.jsx"},{"name":"Button","sourcePath":"dew/components/Button.jsx"},{"name":"Card","sourcePath":"dew/components/Card.jsx"},{"name":"Checkbox","sourcePath":"dew/components/Checkbox.jsx"},{"name":"Dialog","sourcePath":"dew/components/Dialog.jsx"},{"name":"Icon","sourcePath":"dew/components/Icon.jsx"},{"name":"Menu","sourcePath":"dew/components/Menu.jsx"},{"name":"Pagination","sourcePath":"dew/components/Pagination.jsx"},{"name":"Select","sourcePath":"dew/components/Select.jsx"},{"name":"Skeleton","sourcePath":"dew/components/Skeleton.jsx"},{"name":"Switch","sourcePath":"dew/components/Switch.jsx"},{"name":"Table","sourcePath":"dew/components/Table.jsx"},{"name":"TextField","sourcePath":"dew/components/TextField.jsx"},{"name":"Textarea","sourcePath":"dew/components/Textarea.jsx"},{"name":"Toast","sourcePath":"dew/components/Toast.jsx"},{"name":"ToastProvider","sourcePath":"dew/components/Toast.jsx"}],"sourceHashes":{"archive/master/lib/card.js":"a770251d6898","archive/master/lib/iak-ui.js":"857deadf8315","archive/master/lib/icons.js":"2389487dca34","archive/master/lib/patterns.js":"bd000d5ed4e0","archive/ui_kits/rais-dashboard/Components.jsx":"fc2ced315ee7","archive/ui_kits/rais-dashboard/Sidebar.jsx":"98e51da1e403","archive/ui_kits/rais-dashboard/TopBar.jsx":"da2db3676a27","dew/components/AlertDialog.jsx":"145a867d9c5a","dew/components/Badge.jsx":"e683b142ad90","dew/components/Button.jsx":"c3a96d33991a","dew/components/Card.jsx":"9395992288e8","dew/components/Checkbox.jsx":"cbb9f006cba2","dew/components/Dialog.jsx":"8f5798288b8d","dew/components/Icon.jsx":"0cba66329b5e","dew/components/Menu.jsx":"d4df67752ccd","dew/components/Pagination.jsx":"9ba717a4cad9","dew/components/Select.jsx":"85e1b797e5b5","dew/components/Skeleton.jsx":"c7c36d57c5e6","dew/components/Switch.jsx":"c6b3665d2f2c","dew/components/Table.jsx":"60db481f3449","dew/components/TextField.jsx":"e766fb6a0c6c","dew/components/Textarea.jsx":"e1cf0fb8f3c7","dew/components/Toast.jsx":"8bd5f4be3adc","dew/lib/card.js":"76fb6e2339fc","dew/lib/catalog.js":"e9d4c1ef1d0d","dew/lib/dew-ui.js":"22b70516f6a9","dew/lib/editorial.js":"4d84d62c09aa","dew/lib/icons.js":"53496450a9ea","dew/lib/kits.js":"c5978d320da3","dew/lib/patterns.js":"3103046781ad","dew/lib/specs.js":"9771560087de"},"inlinedExternals":[],"unexposedExports":[{"name":"useToast","sourcePath":"dew/components/Toast.jsx"}]} */
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "archive/master/lib/card.js", error: String((e && e.message) || e) }); }

// archive/master/lib/iak-ui.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "archive/master/lib/iak-ui.js", error: String((e && e.message) || e) }); }

// archive/master/lib/icons.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "archive/master/lib/icons.js", error: String((e && e.message) || e) }); }

// archive/master/lib/patterns.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "archive/master/lib/patterns.js", error: String((e && e.message) || e) }); }

// archive/ui_kits/rais-dashboard/Components.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "archive/ui_kits/rais-dashboard/Components.jsx", error: String((e && e.message) || e) }); }

// archive/ui_kits/rais-dashboard/Sidebar.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "archive/ui_kits/rais-dashboard/Sidebar.jsx", error: String((e && e.message) || e) }); }

// archive/ui_kits/rais-dashboard/TopBar.jsx
try { (() => {
// TopBar.jsx
const TopBar = ({
  onToast
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "archive/ui_kits/rais-dashboard/TopBar.jsx", error: String((e && e.message) || e) }); }

// dew/components/AlertDialog.jsx
try { (() => {
// AlertDialog — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function AlertDialog(props) {
  const C = window.DEW && window.DEW.AlertDialog;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { AlertDialog });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/AlertDialog.jsx", error: String((e && e.message) || e) }); }

// dew/components/Badge.jsx
try { (() => {
// Badge — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function Badge(props) {
  const C = window.DEW && window.DEW.Badge;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { Badge });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Badge.jsx", error: String((e && e.message) || e) }); }

// dew/components/Button.jsx
try { (() => {
// Button — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function Button(props) {
  const C = window.DEW && window.DEW.Button;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { Button });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Button.jsx", error: String((e && e.message) || e) }); }

// dew/components/Card.jsx
try { (() => {
// Card — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function Card(props) {
  const C = window.DEW && window.DEW.Card;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { Card });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Card.jsx", error: String((e && e.message) || e) }); }

// dew/components/Checkbox.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Checkbox.jsx", error: String((e && e.message) || e) }); }

// dew/components/Dialog.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Dialog.jsx", error: String((e && e.message) || e) }); }

// dew/components/Icon.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Icon.jsx", error: String((e && e.message) || e) }); }

// dew/components/Menu.jsx
try { (() => {
// Menu — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function Menu(props) {
  const C = window.DEW && window.DEW.Menu;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { Menu });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Menu.jsx", error: String((e && e.message) || e) }); }

// dew/components/Pagination.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Pagination.jsx", error: String((e && e.message) || e) }); }

// dew/components/Select.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Select.jsx", error: String((e && e.message) || e) }); }

// dew/components/Skeleton.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Skeleton.jsx", error: String((e && e.message) || e) }); }

// dew/components/Switch.jsx
try { (() => {
// Switch — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function Switch(props) {
  const C = window.DEW && window.DEW.Switch;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { Switch });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Switch.jsx", error: String((e && e.message) || e) }); }

// dew/components/Table.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Table.jsx", error: String((e && e.message) || e) }); }

// dew/components/TextField.jsx
try { (() => {
// TextField — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function TextField(props) {
  const C = window.DEW && window.DEW.TextField;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { TextField });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/TextField.jsx", error: String((e && e.message) || e) }); }

// dew/components/Textarea.jsx
try { (() => {
// Textarea — export of the DEW port (dew/lib/dew-ui.js; API mirrors uploads/IAK-Master-source/packages/ui/src). Load dew/lib/icons.js + dew/lib/dew-ui.js + styles.css first.
function Textarea(props) {
  const C = window.DEW && window.DEW.Textarea;
  return C ? React.createElement(C, props) : null;
}
Object.assign(__ds_scope, { Textarea });
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Textarea.jsx", error: String((e && e.message) || e) }); }

// dew/components/Toast.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/components/Toast.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  function Case({
    ...
    return h('figure', {
      className: 'dc-case' + (c.wide ? ' wide' : c.w2 ? ' w2' : ''),
      'data-case': c.id,
      'data-tag': c.tag || 'code'
    }, h('div', {
      className: 'dc-demo' + (c.col ? ' col' : ''),
      style: c.demoStyle
    }, c.el), h('figcaption', {
      className: 'dc-cap'
    }, h('span', null, c.label), h('span', {
  ...
  function audit(name, extra) {
    const figs = [...document.querySelectorAll('[data-case]')];
    const cases = figs.map(f => {
      const d = f.querySelector('.dc-demo');
      const r = d.getBoundingClientRect();
      return {
        id: f.dataset.case,
        tag: f.dataset.tag,
    ...
    const tokens = ['--dew-black', '--dew-red', '--dew-action', '--dew-font-display', '--dew-font-sans', '--dew-focus-width', '--dew-motion-base'].map(t => [t, cs.getPropertyValue(t).trim() !== '']);
    const d = document.documentElement;
    window.__DEW_RENDERED = {
      component: name,
      cases,
      tokensLinked: tokens.every(t => t[1]),
      docOverflowX: d.scrollWidth > d.clientWidth + 1,
      width: d.clientWidth,
      ...(extra || {})
    };
    console.log('DEW-CASES ' + JSON.stringify({
      c: name,
      n: cases.length,
      ok: cases.filter(x => x.rendered).length,
      tokens: window.__DEW_RENDERED.tokensLinked,
      docOverflowX: window.__DEW_RENDERED.docOverflowX
    }));
  }
  function Page({
    spec
    ...
    React.useEffect(() => {
      setTimeout(() => audit(spec.name, spec.audit), 60);
    }, []);
    return h('main', {
      className: 'dc'
    }, h('header', {
      ...
      className: 'dew-overline'
    }, 'DEW_V1 · ', spec.group || 'Component'), h('h1', null, spec.name)), h('p', null, spec.description), h('div', {
      className: 'dc-meta'
    }, (spec.meta || []).map((m, i) => h('code', {
      key: i
    }, m)))), spec.sections.map((s, i) => h('section', {
      key: i,
      className: 'dc-sec'
    }, h('header', null, h('span', {
      className: 'n'
    }, String(i + 1).padStart(2, '0')), h('h2', null, s.title), s.note && h('p', null, s.note)), s.body || h('div', {
      className: 'dc-grid',
      style: s.min ? {
        gridTemplateColumns: `repeat(auto-fill,minmax(min(${s.min}px,100%),1fr))`
      } : undefined
    }, s.cases.map(c => h(Case, {
      key: c.id,
      c
      ...
      className: 'n'
    }, '—'), h('h2', null, '소스에 없는 상태 · 렌더하지 않음')), h('div', {
      className: 'dc-note'
    }, spec.notInSource.map((n, i) => h('div', {
      key: i
    }, '· ', n)))) : null, spec.footer || null);
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/card.js", error: String((e && e.message) || e) }); }

// dew/lib/catalog.js
try { (() => {
/* 62-item baseline → DEW file map (shared by hub, QA, IA). */
window.DEW_CATALOG = [{
  "n": 1,
  "baseline": {
    "group": "Brand",
  ...
  "path": "dew/docs/viewer.html",
  "name": "Documentation viewer",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  "n": 2,
  "baseline": {
    "group": "Brand",
    "name": "Docs UI · Document Site",
    "path": "docs/document-ui.html"
  },
  "path": "dew/docs/document-site.html",
  "name": "Docs UI · Document Site",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    ...
    "path": "docs/information-architecture.html"
  },
  "path": "dew/docs/information-architecture.html",
  "name": "Information Architecture",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Brand",
    "name": "Regeneration Stability Test",
    "path": "docs/regeneration-stability-test.html"
  },
  "path": "dew/docs/regeneration-test.html",
  "name": "Regeneration Stability Test",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    ...
    "path": "docs/structural-audit.html"
  },
  "path": "dew/docs/structural-audit.html",
  "name": "Structural Audit",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Brand",
    "name": "TP 01–03 · Stability Bundle",
    "path": "docs/tp-01-03-bundle.html"
  },
  "path": "dew/docs/locks-01-03.html",
  "name": "Locks 01–03 · Grid · Focus · Spacing",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  "n": 7,
  "baseline": {
    "group": "Brand",
    "name": "TP 04–10 · Final Bundle",
    "path": "docs/tp-04-10-bundle.html"
  },
  "path": "dew/docs/locks-04-10.html",
  "name": "Locks 04–10 · Motion · QA · AI · Docs",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  "n": 8,
  "baseline": {
    "group": "Brand",
    "name": "Variant Stress Test",
    "path": "docs/variant-stress-test.html"
  },
  "path": "dew/docs/variant-stress.html",
  "name": "Variant Stress Test",
  "group": "Brand",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Brand",
    "name": "Brand mark",
    "path": "preview/brand.html"
  },
  "path": "dew/preview/brand.html",
  "name": "Brand · DEW wordmark",
  "group": "Brand",
  "basis": "derived"
}, {
  "n": 11,
  "baseline": {
    "group": "Brand",
    "name": "Iconography",
    "path": "preview/iconography.html"
  },
  "path": "dew/preview/iconography.html",
  "name": "Iconography",
  "group": "Brand",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Colors",
    "name": "Colors · Grey scale",
    "path": "preview/colors-grey.html"
  },
  "path": "dew/preview/colors-grey.html",
  "name": "Colors · Grey scale",
  "group": "Colors",
  ...
  "path": "dew/preview/colors-primary.html",
  "name": "Colors · Action red",
  "group": "Colors",
  "basis": "observed + derived"
}, {
  "n": 14,
  ...
  "path": "dew/preview/colors-semantic.html",
  "name": "Colors · Semantic",
  "group": "Colors",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    ...
    "path": "preview/surfaces.html"
  },
  "path": "dew/preview/surfaces.html",
  "name": "Colors · Surfaces",
  "group": "Colors",
  "basis": "observed + derived"
}, {
  ...
  "baseline": {
    "group": "Components",
    "name": "Buttons",
    "path": "preview/buttons.html"
  },
  "path": "dew/preview/buttons.html",
  "name": "Buttons",
  "group": "Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Components",
    "name": "Cards",
    "path": "preview/cards.html"
  },
  "path": "dew/preview/cards.html",
  "name": "Cards",
  "group": "Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Components",
    "name": "Chips & Status",
    "path": "preview/chips.html"
  },
  "path": "dew/preview/chips.html",
  "name": "Chips & Status",
  "group": "Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Components",
    "name": "Inputs",
    "path": "preview/inputs.html"
  },
  "path": "dew/preview/inputs.html",
  "name": "Inputs",
  "group": "Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Components",
    "name": "Toasts",
    "path": "preview/toasts.html"
  },
  "path": "dew/preview/toasts.html",
  "name": "Toasts",
  "group": "Components",
  "basis": "derived"
}, {
  "n": 21,
  "baseline": {
    "group": "Master · Components",
    "name": "AlertDialog",
    "path": "master/preview/AlertDialog.html"
  },
  "path": "dew/components/AlertDialog.html",
  "name": "AlertDialog",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  "n": 22,
  "baseline": {
    "group": "Master · Components",
    "name": "Badge",
    "path": "master/preview/Badge.html"
  },
  "path": "dew/components/Badge.html",
  "name": "Badge",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Button",
    "path": "master/preview/Button.html"
  },
  "path": "dew/components/Button.html",
  "name": "Button",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Card",
    "path": "master/preview/Card.html"
  },
  "path": "dew/components/Card.html",
  "name": "Card",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Checkbox",
    "path": "master/preview/Checkbox.html"
  },
  "path": "dew/components/Checkbox.html",
  "name": "Checkbox",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Dialog",
    "path": "master/preview/Dialog.html"
  },
  "path": "dew/components/Dialog.html",
  "name": "Dialog",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Icon",
    "path": "master/preview/Icon.html"
  },
  "path": "dew/components/Icon.html",
  "name": "Icon",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Menu",
    "path": "master/preview/Menu.html"
  },
  "path": "dew/components/Menu.html",
  "name": "Menu",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Pagination",
    "path": "master/preview/Pagination.html"
  },
  "path": "dew/components/Pagination.html",
  "name": "Pagination",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Select",
    "path": "master/preview/Select.html"
  },
  "path": "dew/components/Select.html",
  "name": "Select",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Skeleton",
    "path": "master/preview/Skeleton.html"
  },
  "path": "dew/components/Skeleton.html",
  "name": "Skeleton",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Switch",
    "path": "master/preview/Switch.html"
  },
  "path": "dew/components/Switch.html",
  "name": "Switch",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Table",
    "path": "master/preview/Table.html"
  },
  "path": "dew/components/Table.html",
  "name": "Table",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Textarea",
    "path": "master/preview/Textarea.html"
  },
  "path": "dew/components/Textarea.html",
  "name": "Textarea",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "TextField",
    "path": "master/preview/TextField.html"
  },
  "path": "dew/components/TextField.html",
  "name": "TextField",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Components",
    "name": "Toast",
    "path": "master/preview/Toast.html"
  },
  "path": "dew/components/Toast.html",
  "name": "Toast",
  "group": "DEW · Components",
  "basis": "derived"
}, {
  "n": 37,
  "baseline": {
    "group": "Master · Foundations",
    "name": "Master foundations",
    "path": "master/preview/foundations.html"
  },
  "path": "dew/preview/foundations.html",
  "name": "DEW foundations",
  "group": "DEW · Foundations",
  "basis": "derived"
}, {
  "n": 38,
  "baseline": {
    "group": "Master · Foundations",
    "name": "Icons · 97 local SVG + 9 unresolved",
    "path": "master/preview/icons.html"
  },
  "path": "dew/preview/icons.html",
  "name": "Icons · 97 SVG + 9 unresolved",
  "group": "DEW · Foundations",
  "basis": "derived"
}, {
  "n": 39,
  "baseline": {
    ...
    "path": "master/preview/mapping.html"
  },
  "path": "dew/preview/mapping.html",
  "name": "Design ↔ Code mapping",
  "group": "DEW · Foundations",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Hub",
    "name": "IAK Master V1 · Hub & integrated preview",
    "path": "master/index.html"
  },
  "path": "dew/preview-app.html",
  "name": "Hub & integrated preview",
  "group": "DEW · Hub",
  "basis": "derived-extension"
}, {
  "n": 41,
  "baseline": {
    "group": "Master · Hub",
    "name": "Namespace check · 16 exports",
    "path": "master/preview/namespace.html"
  },
  "path": "dew/preview/namespace.html",
  "name": "Namespace check · 16 exports",
  "group": "DEW · Hub",
  "basis": "derived"
}, {
  ...
  "baseline": {
    "group": "Master · Hub",
    "name": "Master QA · render check",
    "path": "master/qa.html"
  },
  "path": "dew/qa.html",
  "name": "QA · render check",
  "group": "DEW · Hub",
  "basis": "derived-extension"
}, {
  "n": 43,
  "baseline": {
    ...
    "name": "01 · Dashboard",
    "path": "master/patterns/01-dashboard.html"
  },
  "path": "dew/patterns/01-dashboard.html",
  "name": "01 · Dashboard",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "02 · Analytics",
    "path": "master/patterns/02-analytics.html"
  },
  "path": "dew/patterns/02-analytics.html",
  "name": "02 · Analytics",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "03 · Table",
    "path": "master/patterns/03-table.html"
  },
  "path": "dew/patterns/03-table.html",
  "name": "03 · Table",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "04 · Detail",
    "path": "master/patterns/04-detail.html"
  },
  "path": "dew/patterns/04-detail.html",
  "name": "04 · Detail",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "05 · Settings",
    "path": "master/patterns/05-settings.html"
  },
  "path": "dew/patterns/05-settings.html",
  "name": "05 · Settings",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "06 · Billing",
    "path": "master/patterns/06-billing.html"
  },
  "path": "dew/patterns/06-billing.html",
  "name": "06 · Billing",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "07 · AI Chat",
    "path": "master/patterns/07-chat.html"
  },
  "path": "dew/patterns/07-chat.html",
  "name": "07 · AI Chat",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "08 · Builder",
    "path": "master/patterns/08-builder.html"
  },
  "path": "dew/patterns/08-builder.html",
  "name": "08 · Builder",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "09 · Modal",
    "path": "master/patterns/09-modal.html"
  },
  "path": "dew/patterns/09-modal.html",
  "name": "09 · Modal",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Master · Patterns",
    "name": "10 · Empty",
    "path": "master/patterns/10-empty.html"
  },
  "path": "dew/patterns/10-empty.html",
  "name": "10 · Empty",
  "group": "DEW · Patterns",
  "basis": "derived-extension"
}, {
  ...
  "baseline": {
    "group": "Spacing",
    "name": "Glows",
    "path": "preview/glows.html"
  },
  "path": "dew/preview/glows.html",
  "name": "Emphasis · Rules (glows retired)",
  "group": "Spacing",
  "basis": "derived-extension"
}, {
  "n": 54,
  "baseline": {
    "group": "Spacing",
    "name": "Radii",
    "path": "preview/radii.html"
  },
  "path": "dew/preview/radii.html",
  "name": "Radii",
  "group": "Spacing",
  "basis": "observed + derived"
}, {
  ...
  "baseline": {
    "group": "Spacing",
    "name": "Shadows",
    "path": "preview/shadows.html"
  },
  "path": "dew/preview/shadows.html",
  "name": "Shadows",
  "group": "Spacing",
  "basis": "observed + derived"
}, {
  ...
  "path": "dew/preview/type-display.html",
  "name": "Type · Display",
  "group": "Type",
  "basis": "observed + derived"
}, {
  ...
  "baseline": {
    "group": "Type",
    "name": "Type · Scale",
    "path": "preview/type-scale.html"
  },
  "path": "dew/preview/type-scale.html",
  "name": "Type · Scale",
  "group": "Type",
  "basis": "observed + derived"
}, {
  ...
  "baseline": {
    "group": "Type",
    "name": "Type · Specimens",
    "path": "preview/type-specimens.html"
  },
  "path": "dew/preview/type-specimens.html",
  "name": "Type · Specimens",
  "group": "Type",
  "basis": "observed + derived"
}, {
  ...
  "baseline": {
    "group": "UI Kit — Ai Crm",
    "name": "AI CRM · Main",
    "path": "ui_kits/ai-crm/index.html"
  },
  "path": "dew/kits/reader-crm.html",
  "name": "Kit · Reader CRM",
  "group": "UI Kits",
  "basis": "derived-extension"
}, {
  "n": 61,
  "baseline": {
    "group": "UI Kit — Rais Audit",
    "name": "Audit Dashboard",
    "path": "ui_kits/rais-audit/index v2.html"
  },
  "path": "dew/kits/editorial-audit.html",
  "name": "Kit · Editorial Audit",
  "group": "UI Kits",
  "basis": "derived-extension"
}, {
  "n": 62,
  "baseline": {
    "group": "UI Kit — Rais Dashboard",
    "name": "RAIS Dashboard — UI kit",
    "path": "ui_kits/rais-dashboard/index.html"
  },
  "path": "dew/kits/front-page.html",
  "name": "Kit · Webzine (EditorialHome · ArticleList · StoryDetail)",
  "group": "UI Kits",
  "basis": "derived-extension"
}];
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/catalog.js", error: String((e && e.message) || e) }); }

// dew/lib/dew-ui.js
try { (() => {
/* DEW UI · 16 components. API ported 1:1 from uploads/IAK-Master-source/packages/ui/src (index.tsx, composites.tsx, table.tsx, toast.tsx, alert-dialog.tsx) — same props, class prefix dew-.
   Visual layer is DEW (dew/dew-ui.css). Overlay behaviour (Dialog/Menu/Toast/AlertDialog) is a small dependency-free approximation for previews.
   Preview-only props (not in source API): inline (Dialog, Menu, AlertDialog), previewState (AlertDialog, Pagination), ToastView. */
(function () {
  const h = React.createElement,
    IC = () => window.DEW_ICONS || {};
  ...
  const Button = React.forwardRef(function Button({
    ...
    return h('button', {
      ...
      disabled: disabled || loading,
      'aria-busy': loading || undefined,
      className: cx('dew-button', `dew-button--${variant}`, `dew-button--${size}`, className)
    }, h('span', {
      style: loading ? {
        opacity: 0
      } : undefined
    }, children), loading && h('span', {
      className: 'dew-spinner',
      'aria-hidden': 'true'
    }));
  });
  function useField(id, description, error, describedBy) {
    const uid = React.useId();
    const inputId = id || `dew-${uid}`;
    return {
      inputId,
      helpId: `${inputId}-help`,
      descriptionId: cx(describedBy, (!!error || !!description) && `${inputId}-help`) || undefined
  ...
  function FieldShell({
    ...
    return h('div', {
      ...
      id: helpId,
      className: cx('dew-help', !!error && 'dew-error')
    }, error || description));
  }
  function fieldFactory(tag, extra) {
    return React.forwardRef(function Field({
      ...
      const props = {
        ...
        'aria-describedby': f.descriptionId,
        'aria-invalid': error ? true : p['aria-invalid'],
        className: cx('dew-input', extra, className)
      };
      if (tag === 'textarea') props.rows = p.rows || 4;
      return h(FieldShell, {
        ...f,
  ...
  const TextField = fieldFactory('input'),
    Textarea = fieldFactory('textarea', 'dew-textarea'),
    Select = fieldFactory('select');
  const Checkbox = React.forwardRef(function Checkbox({
    label,
    className,
    ...
    return h('label', {
      className: cx('dew-control', className)
    }, h('input', {
      ...p,
      type: 'checkbox',
      ref
  ...
  const Switch = React.forwardRef(function Switch({
    ...
    return h('label', {
      className: cx('dew-control', 'dew-switch', className)
    }, h('input', {
      ...p,
      type: 'checkbox',
      role: 'switch',
  ...
  function Badge({
    ...
    return h('span', {
      ...p,
      className: cx('dew-badge', `dew-badge--${tone}`, className)
    }, children);
  }
  function Card({
    title,
    ...
    return h('section', {
      ...p,
      'aria-labelledby': title ? id : p['aria-labelledby'],
      className: cx('dew-card', className)
    }, title && h('h2', {
      id
    }, title), h('div', null, children), footer && h('footer', null, footer));
  }
  function Skeleton({
    ...
    return h('span', {
      ...p,
      'aria-hidden': 'true',
      className: cx('dew-skeleton', className),
      style: {
        width,
        height,
        borderRadius: circle ? '50%' : undefined,
  ...
  function Dialog({
    ...
    const content = h(React.Fragment, null, h('div', {
      ...
      'aria-modal': 'true',
      'aria-labelledby': tid,
      className: `dew-dialog dew-dialog--${size}`
    }, h('div', {
      className: 'dew-dialog-heading'
    }, h('h2', {
      id: tid,
      className: 'dew-dialog-title'
    }, title), h('button', {
      type: 'button',
      className: 'dew-dialog-close',
      'aria-label': closeLabel,
      onClick: () => set(false)
    }, h(Glyph, {
      name: 'eva:close-fill'
    }))), description && h('p', {
      className: 'dew-dialog-description'
    }, description), h('div', {
      className: 'dew-dialog-body'
    }, children), footer && h('div', {
      className: 'dew-dialog-footer'
    }, footer)));
    return h(React.Fragment, null, trigger && !inline && React.cloneElement(trigger, {
      onClick: () => set(true),
      'aria-haspopup': 'dialog'
  ...
  function Menu({
    ...
    const list = h('div', {
      ...
      role: 'menu',
      'aria-label': label,
      className: cx('dew-menu', inline && 'dew-menu--inline'),
      'data-align': align,
      onKeyDown: key
    }, items.map(item => h(React.Fragment, {
      key: item.id
      ...
      role: 'separator',
      className: 'dew-menu-separator'
    }), h('div', {
      role: 'menuitem',
      tabIndex: -1,
      'data-id': item.id,
      className: 'dew-menu-item',
      'data-danger': item.danger || undefined,
      'data-disabled': item.disabled || undefined,
      'aria-disabled': item.disabled || undefined,
      'data-highlighted': hi === item.id && !item.disabled ? '' : undefined,
  ...
  function Table({
    ...
    for (let i = first; i < end; i++) {
      ...
      cells.push(h('tr', {
        ...
        className: 'dew-table-virtual-cell',
        style: {
          height: rowHeight
        }
      }, c.cell(row)) : c.cell(row)))));
    ...
    const range = rows.length ? `${startIndex + 1}–${startIndex + visibleRows.length} / ${rows.length}개` : '0개';
    return h('div', {
      className: 'dew-table-root'
    }, h('div', {
      ref: viewport,
      className: cx('dew-table-scroll', virtual && 'dew-table-virtual'),
      style: virtual ? {
        maxHeight: height
      } : undefined,
      role: 'region',
      ...
      type: 'button',
      disabled: loading || !!error,
      className: 'dew-table-sort',
      onClick: () => toggle(c.id)
    }, c.header, h('span', {
      'aria-hidden': 'true'
    }, activeSort && activeSort.columnId === c.id ? activeSort.direction === 'ascending' ? '↑' : '↓' : '↕'), h('span', {
      className: 'dew-sr-only'
    }, ' 정렬')) : c.header)))), h('tbody', null, state ? h('tr', null, h('td', {
      className: 'dew-table-state',
      colSpan: Math.max(columns.length, 1)
    }, state)) : cells))), pagination && h('div', {
      className: 'dew-table-paging'
    }, h('span', null, range), h(Pagination, {
      page,
      pageCount,
      onPageChange: changePage,
  ...
  function ToastView({
    ...
    return h('li', {
      className: `dew-toast dew-toast--${tone}`,
      role: 'status'
    }, h('span', {
      className: 'dew-toast-icon'
    }, h(Glyph, {
      name: toneIcons[tone]
    })), h('div', {
      className: 'dew-toast-content'
    }, h('div', {
      className: 'dew-toast-title'
    }, h('span', {
      className: 'dew-sr-only'
    }, labels[tone] + ': '), title), description && h('div', {
      className: 'dew-toast-description'
    }, description), action && h('button', {
      type: 'button',
      className: 'dew-toast-action',
      'aria-label': action.altText,
      onClick: action.onClick
    }, action.label)), h('button', {
      type: 'button',
      'aria-label': `${title} 알림 닫기`,
      className: 'dew-toast-close',
      'data-preview-state': previewState,
      onClick: onClose
    }, h(Glyph, {
      name: 'eva:close-fill',
  ...
  function AlertDialog({
    ...
    const content = h(React.Fragment, null, h('div', {
      ...
      'aria-describedby': did,
      'aria-busy': pending || undefined,
      className: 'dew-dialog dew-dialog--sm'
    }, h('h2', {
      id: tid,
      className: 'dew-dialog-title'
    }, title), h('p', {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/dew-ui.js", error: String((e && e.message) || e) }); }

// dew/lib/editorial.js
try { (() => {
/* DEW editorial library — 11 reusable parts + 3 example pages (EditorialHome · ArticleList · StoryDetail). window.DEW_ED. Fictional data only. Photos are placeholders (no drawn imagery). */
(function () {
  const h = React.createElement,
    F = React.Fragment,
    D = window.DEW;
  ...
  const Photo = ({
    ...
    className: 'dew-photo' + (tone ? ' dew-photo--' + tone : ''),
    style: {
      aspectRatio: ratio
    }
  }, h('span', null, 'PHOTO · ', label || ratio));
  function EditorialHeader({
    issue = 'No. 27 · Autumn 2026',
    tagline = 'Editorial Webzine',
    title = 'DEW',
    compact
  }) {
    return h('header', {
      ...
      className: 'ed-header-top'
    }, h('span', null, issue), h('span', null, tagline)), compact ? h('span', {
      className: 'dew-wordmark',
      style: {
        font: '400 48px/1 var(--dew-font-display)'
      }
    }, title) : h('h1', {
      className: 'ed-header-mast'
    }, title));
  }
  ...
  function ArticleMeta({
    ...
    const x = [category && h('b', {
      key: 'c'
    }, category), h('span', {
      key: 'a'
    }, author ? '글 ' + author : h('span', {
      className: 'dew-miss'
    }, '필자 미지정')), photographer && h('span', {
      key: 'p'
    }, '사진 ' + photographer), date && h('span', {
      key: 'd'
    }, date), read && h('span', {
      key: 'r'
    }, read)].filter(Boolean);
  ...
  function ImageCaption({
    ...
    }, h('span', null, caption || h('span', {
      className: 'dew-miss'
    }, '캡션 없음')), credit && h('b', null, '© ' + credit));
  }
  function MediaCard({
    label,
    ratio = '4/3',
    ...
    return h('figure', {
      ...
      className: 'ed-media-frame'
    }, h(Photo, {
      label,
      ratio,
      tone
    }), kind && h('span', {
      className: 'ed-media-badge',
      'aria-label': kind === 'video' ? '영상' : '갤러리'
    }, h(Icon, {
      name: kind === 'video' ? 'eva:arrow-ios-forward-fill' : 'solar:square-double-alt-arrow-right-bold',
      size: 20
    }))), h(ImageCaption, {
      caption,
      credit
  ...
  function StoryCard({
    ...
    return h('a', {
      href: '#',
      className: 'ed-card' + (layout === 'row' ? ' ed-card--row' : '')
    }, h(Photo, {
      label: s.photo,
      ratio: s.ratio || '4/3',
      tone: s.tone
      ...
      className: 'dew-overline' + (s.featured ? ' dew-overline--red' : '')
    }, s.category || 'STORY'), h('h3', null, s.title || h('span', {
      className: 'dew-miss'
    }, '제목 없음')), s.dek && h('p', null, s.dek), h(ArticleMeta, {
      author: s.author,
      read: s.read
    })));
  }
  function EditorialGrid({
    ...
    return h('div', {
      className: 'ed-grid' + (asymmetric ? ' ed-grid--asym' : '')
    }, children);
  }
  function FeatureStory({
    ...
    const s = story;
    return h('article', {
      className: 'ed-feature' + (reverse ? ' ed-feature--reverse' : '')
    }, h(MediaCard, {
      label: 'COVER 16:10',
      ratio: '16/10',
      tone: 'dark',
      caption: s.caption,
      credit: s.photographer
    }), h('div', {
      className: 'ed-feature-copy'
    }, h('span', {
      className: 'dew-overline dew-overline--red'
    }, s.category), h('h2', null, s.title), h('p', {
      className: 'dew-lead',
      style: {
        margin: 0
      }
  ...
  function QuoteBlock({
    ...
    return h('blockquote', {
      className: 'ed-quote'
    }, h('p', null, '“', quote, '”'), cite && h('footer', null, '— ', cite));
  }
  function EditorialCTA({
    title = '매주 목요일, 한 편의 긴 글',
    body = '광고 없는 뉴스레터. 언제든 해지할 수 있습니다.',
    tone = 'dark',
    state = 'default'
  }) {
    ...
    const bad = st === 'error';
    return h('section', {
      className: 'ed-cta' + (tone === 'light' ? ' ed-cta--light' : ''),
      'aria-label': '뉴스레터'
    }, h('div', null, h('span', {
      className: 'dew-overline',
      style: {
    ...
    }, 'NEWSLETTER'), h('h2', null, st === 'success' ? '구독해 주셔서 감사합니다' : title), h('p', null, st === 'success' ? '확인 메일을 보냈습니다.' : body)), st === 'success' ? h('div', null, h(Badge, {
      tone: 'success'
    }, '구독 완료')) : h('form', {
      noValidate: true,
      onSubmit: e => {
        e.preventDefault();
        setSt(/.+@.+\..+/.test(v) ? 'success' : 'error');
      }
    }, h('div', {
      className: 'dew-field'
    }, h('label', {
      ...
      'aria-describedby': bad ? 'ed-nl-err-' + tone : undefined
    }), bad && h('p', {
      id: 'ed-nl-err-' + tone,
      className: 'dew-error',
      style: {
        color: tone === 'light' ? undefined : '#FF8A80'
      }
    }, '이메일 형식을 확인하세요.')), h(Button, {
      type: 'submit'
    }, '구독하기')));
  }
  function Footer() {
    const col = (t, l) => h('div', null, h('h4', null, t), h('ul', null, l.map(x => h('li', {
      key: x
    }, h('a', {
      href: '#'
    }, x)))));
    return h('footer', {
      ...
      className: 'dew-small dew-muted',
      style: {
        margin: 0,
        maxWidth: '32ch'
      }
    }, '도시와 사람, 책과 음악에 관한 긴 글을 싣는 가상의 웹진.')), col('Sections', ['Features', 'Essay', 'Interview', 'Review']), col('Magazine', ['Archive', 'Contributors', 'About']), col('Follow', ['Newsletter', 'RSS', 'Contact']), h('div', {
      className: 'ed-footer-legal'
    }, h('span', null, '© 2026 DEW · 가상 데이터 · 파생 UI kit'), h('span', null, '사진 자리표시 · 실제 이미지 미포함')));
  }
  /* data */
  const CATS = ['All', 'Features', 'Essay', 'Interview', 'Review', 'Archive'];
  const COVER = {
    category: 'COVER STORY',
    title: '골목 끝, 불 켜진 서점',
    dek: '오래된 동네의 서점들은 어떻게 저녁을 맞이하는가. 세 곳의 책방 주인과 보낸 가을 오후.',
    author: '한지우',
    photographer: '오하람',
    read: '12분',
    caption: '망원동의 한 책방, 오후 5시 40분'
  };
  const STORIES = [{
    category: 'ESSAY',
    title: '종이의 촉감에 대하여',
    dek: '손끝으로 읽는 책에 관한 짧은 에세이.',
    author: '정민',
    read: '6분',
    ratio: '4/5',
    tone: 'light'
    ...
    category: 'INTERVIEW',
    title: '작은 출판사의 다섯 번째 책',
    dek: '1인 출판사 대표와 나눈 대화.',
    author: '이도현',
    read: '9분',
    ratio: '4/3',
    tone: 'mid'
    ...
    category: 'FEATURES',
    title: '2026 가을호 특집 — 도시의 오래된 골목과 새로 문을 연 작은 서점들을 따라 걷는 아주 긴 산책의 기록',
    dek: '긴 제목 · 줄바꿈 검증용 사례.',
    author: '한지우',
    read: '18분',
    ratio: '4/3',
  ...
  function EditorialHome() {
    ...
    return h('div', {
      ...
      'data-case': 'header',
      'data-tag': 'observed'
    }, h(EditorialHeader), h(CategoryNav, {
      items: CATS,
      current: c,
      onSelect: setC
    })), h('div', {
      ...
      className: 'dew-h2',
      style: {
        borderTop: 'var(--dew-rule-heavy)',
        paddingTop: 12,
        margin: 0
      }
    }, 'This issue'), h(EditorialGrid, null, STORIES.slice(0, 3).map(s => h(StoryCard, {
      key: s.title,
      story: s
    })))), h('div', {
      'data-case': 'quote',
      ...
      quote: '책방의 불은 손님이 아니라 동네를 위해 켜 둡니다.',
      cite: '책방 주인 인터뷰 중'
    })), h('section', {
      'data-case': 'media',
      'data-tag': 'derived',
  ...
  function ArticleList() {
    ...
    const list = c === 'All' ? STORIES : STORIES.filter(s => s.category === c.toUpperCase());
    return h('div', {
      className: 'dew-container',
      style: {
        display: 'grid',
    ...
    }, st === 'loading' ? [0, 1, 2].map(i => h('div', {
      key: i,
      style: {
        padding: '20px 0',
        borderBottom: 'var(--dew-rule-hair)'
      }
    }, h(StoryCard, {
      loading: true
    }))) : st === 'empty' || !list.length ? h('div', {
      style: {
        padding: '64px 0',
        display: 'grid',
        gap: 12,
    ...
    }, '이 카테고리에는 아직 기사가 없습니다'), h(Button, {
      variant: 'secondary',
      onClick: () => {
        setC('All');
        setSt('default');
      }
    }, '모든 기사 보기')) : list.map(s => h(StoryCard, {
      key: s.title,
      story: s,
      layout: 'row'
    }))), h('div', {
      'data-case': 'list-pagination',
      'data-tag': 'code',
      style: {
        display: 'flex',
        justifyContent: 'center'
  ...
  function StoryDetail() {
    return h('div', {
      ...
      'data-case': 'story-hero',
      'data-tag': 'observed'
    }, h(MediaCard, {
      label: 'FULL BLEED 21:9',
      ratio: '21/9',
      tone: 'dark',
      caption: COVER.caption,
      credit: COVER.photographer
    })), h('div', {
      className: 'ed-article',
      'data-case': 'story-body',
      'data-tag': 'derived'
    }, h('div', {
      className: 'ed-article-body'
    }, h('p', null, '해가 기울면 골목의 간판들이 하나둘 켜진다. 서점의 불은 조금 늦게, 그러나 가장 오래 켜져 있다. 책방 주인은 저녁 손님보다 지나가는 이웃을 위해 불을 켠다고 말했다.'), h('p', null, '세 곳의 책방은 규모도, 서가의 성격도 다르다. 한 곳은 시집만 두고, 다른 한 곳은 동네 사람들이 맡긴 헌책을 판다. 마지막 한 곳은 문을 연 지 석 달이 되었다.'), h(QuoteBlock, {
      quote: '오래 머무는 손님이 많을수록 책은 덜 팔려요. 그래도 괜찮습니다.',
      cite: '시집 서점 주인'
    }), h(MediaCard, {
      label: 'INLINE 3:2',
      ratio: '3/2',
      ...
      caption: null,
      credit: null
    }), h('p', null, '이 기사는 가상의 예시입니다. 인물·장소·수치는 모두 지어낸 것입니다.')), h('aside', {
      className: 'ed-article-aside',
      'aria-label': '관련 기사'
    }, h('span', {
      className: 'dew-overline'
    }, 'RELATED'), STORIES.slice(1, 3).map(s => h(StoryCard, {
      key: s.title,
      story: {
        ...s,
        dek: null
  ...
  function Parts() {
    const P = (n, tag, el) => h('section', {
      className: 'ed-part',
      'data-case': 'part-' + n,
      'data-tag': tag
    }, h('header', null, h('span', null, n), h('span', null, tag)), el);
    return h('div', {
      className: 'dew-container ed-parts',
      style: {
        paddingTop: 32,
        paddingBottom: 48
      }
    }, P('EditorialHeader', 'observed', h(F, null, h(EditorialHeader), h('div', {
      style: {
        height: 16
      }
    }), h(EditorialHeader, {
      compact: true,
      tagline: 'Archive'
    }))), P('CategoryNav', 'derived', h(CategoryNav, {
      items: CATS,
      current: 'Essay'
    })), P('FeatureStory', 'observed', h(FeatureStory, {
      story: COVER,
      reverse: true
    })), P('StoryCard', 'derived', h('div', {
      className: 'ed-grid'
    }, h('div', null, h(StoryCard, {
      story: STORIES[0]
    })), h('div', null, h(StoryCard, {
      story: STORIES[3]
    })), h('div', null, h(StoryCard, {
      ...
      loading: true
    })))), P('StoryCard · row', 'derived', h(StoryCard, {
      story: STORIES[1],
      layout: 'row'
    })), P('MediaCard', 'derived', h('div', {
      className: 'ed-grid'
    }, h('div', null, h(MediaCard, {
      label: '4:3',
      caption: '캡션 + 크레딧',
      credit: '오하람'
    })), h('div', null, h(MediaCard, {
      ...
      tone: 'dark',
      caption: '영상 · 3분'
    })))), P('EditorialGrid', 'derived', h(EditorialGrid, null, STORIES.slice(0, 3).map(s => h(StoryCard, {
      key: s.title,
      story: s
    })))), P('QuoteBlock', 'derived', h(QuoteBlock, {
      quote: '오래 머무는 손님이 많을수록 책은 덜 팔려요. 그래도 괜찮습니다.',
      cite: '시집 서점 주인'
    })), P('ImageCaption', 'derived', h('div', {
      style: {
        display: 'grid',
        gap: 12
      }
      ...
      author: null,
      read: '4분'
    }))), P('EditorialCTA', 'derived', h('div', {
      style: {
        display: 'grid',
        gap: 16
      }
    }, h(EditorialCTA), h(EditorialCTA, {
      tone: 'light',
      state: 'error'
    }), h(EditorialCTA, {
      tone: 'light',
      state: 'success'
    }))), P('Footer', 'derived', h(Footer)));
  }
  const PAGES = [['home', 'EditorialHome', EditorialHome], ['list', 'ArticleList', ArticleList], ['story', 'StoryDetail', StoryDetail], ['parts', 'Parts · 11', Parts]];
  function EditorialKit() {
    const q = new URLSearchParams(location.search).get('view');
    const [v, setV] = React.useState(PAGES.some(p => p[0] === q) ? q : 'home');
    const Cur = PAGES.find(p => p[0] === v)[2];
    return h('div', {
      className: 'dp'
    }, h('div', {
      className: 'ed-kit-tabs'
    }, h('div', {
      role: 'tablist',
      'aria-label': '편집 예시'
    }, PAGES.map(([k, l]) => h('button', {
      key: k,
      role: 'tab',
      'aria-selected': v === k,
      onClick: () => setV(k)
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/editorial.js", error: String((e && e.message) || e) }); }

// dew/lib/icons.js
try { (() => {
/* DEW icon data — 97 SVGs verbatim from uploads/IAK-Master-source/data/developer/icons.json (Eva/Solar, reused as neutral glyph source). 9 names unresolved. All render in currentColor. */
window.DEW_ICONS = {
  "eva:alert-circle-outline": {
    "body": "<path fill=\"currentColor\" d=\"M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2m0 18a8 8 0 1 1 8-8a8 8 0 0 1-8 8\"/><circle cx=\"12\" cy=\"16\" r=\"1\" fill=\"currentColor\"/><path fill=\"currentColor\" d=\"M12 7a1 1 0 0 0-1 1v5a1 1 0 0 0 2 0V8a1 1 0 0 0-1-1\"/>",
    "width": 24,
...
window.DEW_ICONS_UNRESOLVED = ["solar:bank-bold", "solar:focus-bold", "solar:gem-bold", "solar:magic-stick-3-bold", "solar:magic-stick-bold", "solar:percent-circle-bold", "solar:shapes-bold", "solar:square-bold", "solar:square-bold-duotone"];
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/icons.js", error: String((e && e.message) || e) }); }

// dew/lib/kits.js
try { (() => {
/* DEW · 3 UI kits (derived from archived IAK kit slots). Fictional data only. */
(function () {
  const h = React.createElement,
    F = React.Fragment,
    D = window.DEW;
  ...
  const Ph = (l, r, t) => h('div', {
    className: 'dew-photo' + (t ? ' dew-photo--' + t : ''),
    style: {
      aspectRatio: r
    }
  }, h('span', null, 'PHOTO · ', l));
  const Top = (sub, links, active) => {
    const [o, setO] = React.useState(false);
    return h(F, null, h('header', {
      className: 'dp-top'
    }, h('div', {
      className: 'dp-top-in'
    }, h('button', {
      type: 'button',
      className: 'dp-ib dp-menu-btn',
      'aria-label': '메뉴',
      'aria-expanded': o,
      onClick: () => setO(!o)
    }, h(Icon, {
      name: o ? 'eva:close-fill' : 'solar:list-bold'
    })), h('span', {
      className: 'dew-wordmark'
    }, 'DEW', h('small', {
      className: 'dp-hide-sm'
    }, sub)), h('nav', {
      className: 'dp-nav',
      'aria-label': '메뉴'
    }, links.map((l, i) => h('a', {
  ...
  /* front page */
  const STORIES = [['ESSAY', '종이의 촉감에 대하여', '글 정민', '4/3', 'light'], ['INTERVIEW', '작은 출판사의 다섯 번째 책', '글 이도현', '4/3', 'mid'], ['REVIEW', '가을 음반 다섯 장', '글 박세린', '4/3', null]];
  function FrontPage() {
    return h('div', {
      className: 'dp'
    }, Top('WEBZINE', ['Features', 'Essay', 'Interview', 'Review', 'Archive'], 0), h('main', {
      className: 'dp-body'
    }, h('section', {
      'data-case': 'masthead',
      'data-tag': 'observed',
      style: {
        borderBottom: 'var(--dew-rule-heavy)',
        paddingBottom: 16,
        display: 'grid',
        gap: 12
      }
      ...
      className: 'dew-overline'
    }, 'No. 27 · Autumn 2026'), h('span', {
      className: 'dew-overline dp-hide-sm'
    }, 'Editorial Webzine')), h('h1', {
      className: 'dew-masthead',
      style: {
      ...
      className: 's8'
    }, Ph('COVER 16:10', '16/10', 'dark')), h('div', {
      className: 's4 stack'
    }, h('span', {
      className: 'dew-overline dew-overline--red'
    }, 'COVER STORY'), h('h2', {
      ...
      className: 'dew-lead'
    }, '오래된 동네의 서점들은 어떻게 저녁을 맞이하는가. 세 곳의 책방 주인과 보낸 가을 오후.'), h('div', {
      className: 'dew-byline'
    }, h('span', null, '글 한지우'), h('span', null, '사진 오하람'), h('span', null, '12분')), h('div', null, h(Button, {
      variant: 'text'
    }, 'READ STORY')))), h('section', {
      className: 'g12',
      'data-case': 'grid',
      'data-tag': 'derived',
      style: {
        borderTop: 'var(--dew-rule)',
        paddingTop: 24
      }
    }, STORIES.map(([o, t, b, r, tn], i) => h('a', {
      key: t,
      href: '#',
      className: 'story s4',
      style: i === 1 ? {
      ...
      className: 'dew-overline'
    }, o), h('h3', null, t), h('span', {
      className: 'dew-caption'
    }, b)))), h('section', {
      className: 'g12',
      'data-case': 'list',
      'data-tag': 'derived'
      ...
      className: 's7 list-rule',
      style: {
        listStyle: 'none',
        margin: 0,
        padding: 0
      }
    }, ['밤의 도서관', '편집자의 책상', '오래된 극장의 마지막 상영', '지하철 2호선의 시'].map((t, i) => h('li', {
      key: t,
      className: 'row',
      style: {
        gap: 24,
      ...
      style: {
        font: '400 44px/1 var(--dew-font-display)',
        color: 'var(--dew-grey-300)',
        width: 48
      }
    }, String(i + 1).padStart(2, '0')), h('a', {
      href: '#',
      className: 'grow',
      style: {
        font: 'var(--dew-text-h3)',
        textDecoration: 'none'
      }
    }, t))))), h('section', {
      className: 'g12',
      'data-case': 'newsletter',
      'data-tag': 'derived',
      style: {
        background: 'var(--dew-black)',
        color: '#fff',
        padding: '40px var(--dew-container-pad)',
        marginInline: 'calc(var(--dew-container-pad) * -1)'
      }
    }, h('div', {
      className: 's6 stack'
    }, h('span', {
      ...
      className: 'dp-foot'
    }, h('span', null, 'DEW · 가상 데이터 · 파생 UI kit'), h('span', null, '© 2026')));
  }
  /* reader CRM */
  const COLS = [['신규', 'neutral', [['김서연', '뉴스레터 가입', '2일 전'], ['Lee J.', '특집 공유 유입', null]]], ['체험', 'warning', [['박도윤', 'MEMBER 체험 5/14일', '오늘'], ['최유나', '아카이브 12편 읽음', '어제']]], ['구독', 'success', [['오하람', 'PATRON · 연간', '3개월'], ['정민', 'MEMBER', '8개월'], ['한지우', 'MEMBER · 종이판', '1년']]], ['이탈 위험', 'error', [['윤재', '30일 미방문', '—']]]];
  function ReaderCRM() {
    return h('div', {
      className: 'dp'
    }, Top('READERS', ['Pipeline', 'Readers', 'Campaigns', 'Reports'], 0), h('main', {
      className: 'dp-body'
    }, h('div', {
      className: 'dp-head'
    }, h('div', null, h('div', {
      className: 'dew-overline dew-overline--red'
    }, 'READER PIPELINE'), h('h1', null, '독자 관계')), h('div', {
      className: 'dp-actions'
    }, h(Button, {
      variant: 'secondary'
    }, '내보내기'), h(Button, null, '캠페인 만들기'))), h('div', {
      className: 'g12',
      'data-case': 'kpi',
      'data-tag': 'derived'
    }, [['신규', '214'], ['체험 전환', '18%'], ['유료 구독', '3,902'], ['이탈 위험', '41']].map(([k, v]) => h('div', {
      key: k,
      className: 's3'
    }, h('div', {
      className: 'kpi'
      ...
      className: 'dew-numeral'
    }, v))))), h('div', {
      className: 'g12',
      'data-case': 'pipeline',
      'data-tag': 'derived'
    }, COLS.map(([t, tone, cards]) => h('section', {
      key: t,
      className: 's3 stack',
      'aria-label': t
    }, h('div', {
      ...
      tone
    }, cards.length)), cards.map(([n, d, w]) => h('article', {
      key: n,
      className: 'dew-card',
      style: {
        gap: 8,
      ...
      className: 'dew-lead'
    }, '체험 5일 차 독자 2명에게 “가을호 커버 스토리” 추천 메일을 보내면 전환에 도움이 될 수 있습니다.'), h('div', {
      className: 'row'
    }, h(Button, {
      size: 'sm'
    }, '메일 초안'), h(Button, {
  ...
  const AR = [{
    ...
    id: 5,
    t: '2026 가을호 특집 — 도시의 오래된 골목과 새로 문을 연 작은 서점들을 따라 걷는 긴 산책 기록',
    ph: null,
    cap: null,
    sp: null,
    ln: null
  }];
  const mk = v => v == null ? h('span', {
    className: 'dew-miss'
  }, '미검사') : v ? h(Badge, {
    tone: 'success'
  }, 'OK') : h(Badge, {
  ...
  function EditorialAudit() {
    const done = AR.filter(r => r.ph && r.cap && r.sp && r.ln).length;
    return h('div', {
      className: 'dp'
    }, Top('AUDIT', ['Issue 27', 'Checklist', 'Rights', 'History'], 1), h('main', {
      className: 'dp-body'
    }, h('div', {
      className: 'dp-head'
    }, h('div', null, h('div', {
      className: 'dew-overline dew-overline--red'
    }, 'PRE-PRESS CHECK · No. 27'), h('h1', null, '발행 전 점검'), h('p', null, '사진 권리·캡션·맞춤법·링크를 기사별로 확인합니다. 모두 가상 데이터.')), h('div', {
      className: 'dp-actions'
    }, h(Button, {
      disabled: done < AR.length
    }, '발행 승인'))), h('div', {
      className: 'g12',
      'data-case': 'summary',
      'data-tag': 'derived'
    }, [['점검 완료', done + ' / ' + AR.length], ['사진 권리 미확인', AR.filter(r => !r.ph).length], ['캡션 수정', AR.filter(r => r.cap === false).length], ['미검사 항목', AR.reduce((a, r) => a + ['ph', 'cap', 'sp', 'ln'].filter(k => r[k] == null).length, 0)]].map(([k, v]) => h('div', {
      key: k,
      className: 's3'
    }, h('div', {
      className: 'kpi'
      ...
      label: '담당',
      'aria-label': '담당'
    }, h('option', null, '전체'), h('option', null, '이도현')))), h('div', {
      'data-case': 'table',
      'data-tag': 'code'
    }, h(Table, {
      caption: '기사별 점검',
    ...
    }, h('b', null, '발행 승인 전 해결할 항목이 있습니다'), h('span', {
      className: 'dew-small dew-muted'
    }, '“작은 출판사 인터뷰” 사진 권리 확인서가 없습니다.')))));
  }
  window.DEW_KITS = {
    FrontPage,
    ReaderCRM,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/kits.js", error: String((e && e.message) || e) }); }

// dew/lib/patterns.js
try { (() => {
/* DEW · 10 derived patterns rendered with DEW components. Fictional newsroom data only. */
(function () {
  const h = React.createElement,
    F = React.Fragment,
    D = window.DEW;
  ...
  const TV = D.preview.ToastView;
  const LONG = '2026 가을호 특집 — 도시의 오래된 골목과 새로 문을 연 작은 서점들을 따라 걷는 아주 긴 산책 기록과 그 주변 사람들의 이야기';
  const months = ['4월', '5월', '6월', '7월', '8월', '9월'];
  const reads = [182, 204, 196, 231, 248, 263],
    prev = [160, 171, 180, 190, 205, 214];
  const SEC = ['특집', '인터뷰', '에세이', '리뷰'];
  const ST = ['발행됨', '검토 중', '초안', '반려'],
    TONE = {
      '발행됨': 'success',
      '검토 중': 'warning',
      '초안': 'neutral',
  ...
  const TITLES = ['골목 끝, 불 켜진 서점', '도시의 여백을 걷다', '작은 출판사 인터뷰', '가을 음반 리뷰', '종이의 촉감에 대하여', '밤의 도서관', '편집자의 책상', '오래된 극장의 마지막 상영', '사진가 K의 한 해', '지하철 2호선의 시', '바다를 닮은 식탁', '연말 특집 예고'];
  const AUTH = ['한지우', '이도현', null, '박세린', '정민', '오하람'];
  const arts = TITLES.map((t, i) => ({
    id: 'DEW-' + (2701 + i),
    t,
    a: AUTH[i % 6],
    sec: SEC[i % 4],
    s: ST[i % 4],
    d: '2026-09-' + String(25 - i).padStart(2, '0'),
    v: i % 5 === 2 ? null : 24800 - i * 1730
  }));
  const miss = (v, t) => v == null || v === '' ? h('span', {
    className: 'dew-miss'
  }, t || '—') : v;
  const num = v => v == null ? miss(null) : v.toLocaleString('ko-KR');
  const Photo = (label, ratio, tone) => h('div', {
    className: 'dew-photo' + (tone ? ' dew-photo--' + tone : ''),
    style: {
      aspectRatio: ratio
    }
  }, h('span', null, 'PHOTO · ', label));
  /* charts: data roles black/grey, red = single highlight */
  function Line({
    a11y
  }) {
    const W = 600,
      ...
      max = 300,
      step = W / 5,
      pts = s => s.map((v, i) => `${i * step},${H - v / max * H}`).join(' ');
    return h('svg', {
      className: 'chart',
      viewBox: `0 -8 ${W} ${H + 32}`,
      role: 'img',
      ...
      cy: H - reads[5] / max * H,
      r: 5,
      fill: 'var(--dew-data-accent)'
    }), months.map((l, i) => h('text', {
      key: l,
      x: Math.min(W - 14, Math.max(14, i * step)),
      y: H + 22,
      textAnchor: 'middle',
  ...
  function Bars({
    ...
    return h('div', {
      ...
      style: {
        height: 6,
        background: 'var(--dew-grey-100)'
      }
    }, h('div', {
      style: {
        height: 6,
        width: v[i] + '%',
        background: i ? 'var(--dew-data-1)' : 'var(--dew-data-accent)'
      }
    })))));
  }
  const Legend = () => h('div', {
    ...
    style: {
      background: 'var(--dew-data-1)'
    }
  }), '이번 분기'), h('span', null, h('i', {
    style: {
      background: 'var(--dew-data-3)'
    }
  }), '지난 분기'), h('span', null, h('i', {
    style: {
      background: 'var(--dew-data-accent)',
      height: 6,
      width: 6,
      borderRadius: '50%'
    }
  ...
  /* shell */
  const NAV = [['dashboard', '편집국'], ['analytics', '독자 분석'], ['table', '기사'], ['chat', '어시스턴트'], ['builder', '지면 빌더'], ['billing', '구독'], ['settings', '설정']];
  function Shell({
    active,
    children,
    state
    ...
    const [nav, setNav] = React.useState(false);
    const links = NAV.map(([k, l]) => h('a', {
      key: k,
      href: `screen.html?p=${k}`,
      'aria-current': active === k ? 'page' : undefined
    }, l));
    return h('div', {
      className: 'dp',
      ...
      type: 'button',
      className: 'dp-ib dp-menu-btn',
      'aria-label': nav ? '메뉴 닫기' : '메뉴 열기',
      'aria-expanded': nav,
      onClick: () => setNav(!nav)
    }, h(Icon, {
      name: nav ? 'eva:close-fill' : 'solar:list-bold'
    })), h('a', {
      className: 'dew-wordmark',
      href: 'screen.html?p=dashboard'
    }, 'DEW', h('small', {
      className: 'dp-hide-sm'
    }, 'NEWSROOM')), h('nav', {
      className: 'dp-nav',
      ...
      className: 'dp-foot'
    }, h('span', null, 'DEW_V1 · 파생 사례 · 가상 데이터'), h('span', null, 'No. 27 · 2026 가을')));
  }
  const Head = (ov, t, d, actions) => h('div', {
    className: 'dp-head'
  }, h('div', null, h('div', {
    className: 'dew-overline dew-overline--red'
  }, ov), h('h1', null, t), d && h('p', null, d)), actions && h('div', {
    className: 'dp-actions'
  }, actions));
  const Err = msg => h('div', {
    className: 'banner',
  ...
  const Empty = (n, t, d, action) => h('div', {
    className: 'empty'
  }, h('div', {
    className: 'n',
    'aria-hidden': 'true'
  }, n), h('h2', null, t), h('p', null, d), action && h('div', {
    className: 'row'
  }, action));
  const Kpi = (t, v, d, up, cls = 's3') => h('div', {
    className: cls
  }, h('div', {
    className: 'kpi'
  }, h('div', {
  ...
  function Dashboard({
    ...
    return h(Shell, {
      active: 'dashboard',
      state: s
    }, Head('EDITORIAL DESK · 9월 25일', '편집국', s === 'empty' ? null : '이번 호 진행 상황과 오늘 읽힌 기사를 한 지면에서 봅니다.', h(F, null, h(Button, {
      variant: 'secondary'
    }, '이번 호 보기'), h(Button, null, h(Icon, {
      name: 'eva:plus-fill',
      size: 16
    }), '새 기사'))), s === 'error' ? Err('편집국 지표 서버에 연결할 수 없습니다. 잠시 후 다시 시도하세요.') : null, s === 'empty' ? Empty('00', '아직 이번 호 기사가 없습니다', '첫 기사를 작성하면 발행 현황과 독자 지표가 이 지면에 채워집니다.', h(Button, null, '첫 기사 쓰기')) : h(F, null, h('div', {
      className: 'g12'
    }, L ? [1, 2, 3, 4].map(i => SkKpi('s3', i)) : s === 'error' ? [['발행', null], ['조회', null], ['구독자', null], ['평균 체류', null]].map(([t]) => h('div', {
      key: t,
      className: 's3'
    }, h('div', {
      className: 'kpi'
      ...
      className: 'dew-numeral dew-miss'
    }, '—')))) : [Kpi('이번 주 발행', '14', '+3 지난주', true), Kpi('오늘 조회', '26,310', '+8.2%', true), Kpi('구독자', '12,480', '+124', true), Kpi('평균 체류', '3분 42초', '-12초', false)].map((k, i) => h(F, {
      key: i
    }, k))), h('div', {
      className: 'g12'
    }, h('article', {
      ...
      height: 420
    }) : Photo('LEAD STORY 16:10', '16/10', 'dark'), h('div', {
      className: 'dew-overline dew-overline--red'
    }, '이번 호 커버'), L ? h(Skeleton, {
      height: 40,
      width: '80%'
    }) : h('h2', {
      className: 'dew-h2'
      ...
      className: 'dew-byline'
    }, h('span', null, '글 한지우'), h('span', null, '사진 오하람'), h('span', null, '발행 예정 10월 1일'))), h('div', {
      className: 's5 stack',
      style: {
        gap: 24
      }
      ...
      className: 'dew-h3'
    }, '월간 조회'), h(Legend)), L ? h(Skeleton, {
      height: 200
    }) : s === 'error' ? h('p', {
      className: 'dew-muted dew-small'
    }, '차트를 표시할 수 없습니다.') : h(Line, {
      a11y: '4월부터 9월까지 월간 조회 추이, 9월 263천'
    })), h('div', {
      className: 'stack'
    }, h('h2', {
      className: 'dew-h3'
    ...
    }, (L ? [0, 1, 2, 3] : arts.slice(0, 4)).map((a, i) => h('li', {
      key: i,
      className: 'row',
      style: {
        alignItems: 'baseline',
      ...
      style: {
        font: '400 28px/1 var(--dew-font-display)',
        color: 'var(--dew-fg-3)',
        width: 28
      }
    }, i + 1), L ? h(Skeleton, {
  ...
  function Analytics({
    ...
    return h(Shell, {
      active: 'analytics',
      state: s
    }, Head('READERS · 3분기', '독자 분석', '섹션별 읽힘과 구독 전환을 분기 단위로 비교합니다.', h(F, null, h(Select, {
      label: '기간',
      'aria-label': '기간',
      defaultValue: 'q3'
    }, h('option', {
      ...
      name: 'eva:download-fill',
      size: 16
    }), 'CSV'))), s === 'error' && Err('분석 데이터 집계가 지연되고 있습니다.'), s === 'empty' ? Empty('0', '이 기간에 집계된 독자가 없습니다', '기간을 넓히거나 발행된 기사가 있는 분기를 선택하세요.', h(Button, {
      variant: 'secondary'
    }, '기간 초기화')) : h(F, null, h('div', {
      className: 'g12'
    }, L ? [1, 2, 3, 4].map(i => SkKpi('s3')) : [Kpi('순 독자', '48,210', '+6.1%', true), Kpi('구독 전환', '3.4%', '+0.3%p', true), Kpi('재방문', '41%', '-2%p', false), Kpi('공유', '2,904', null, true)].map((k, i) => h(F, {
      key: i
    }, k))), h('div', {
      className: 'g12'
    }, h('section', {
      ...
      a11y: '섹션별 조회 비중, 특집 42%'
    }))), h(Table, {
      caption: '많이 읽힌 기사 · 3분기',
      columns: aCols(true).slice(0, -1),
      rows: s === 'error' ? [] : arts.slice(0, 6),
      rowKey: r => r.id,
      loading: L,
      error: s === 'error' ? '표를 불러오지 못했습니다.' : undefined,
      defaultSort: {
        columnId: 'v',
        direction: 'descending'
      }
  ...
  function TablePage({
    ...
    const rows = s === 'empty' ? [] : s === 'long-text' ? arts.map((a, i) => i % 3 === 0 ? {
      ...a,
      t: LONG,
      a: a.a || null
    } : a) : arts;
    const [w, setW] = React.useState(innerWidth);
    React.useEffect(() => {
      const r = () => setW(innerWidth);
    ...
    return h(Shell, {
      active: 'table',
      state: s
    }, Head('ARCHIVE', '기사', `전체 ${s === 'empty' ? 0 : arts.length}건 · 필자와 상태로 걸러 보세요.`, h(Button, null, h(Icon, {
      name: 'eva:plus-fill',
      size: 16
    }), '새 기사')), h('div', {
      className: 'g12'
      ...
      label: '검색',
      type: 'search',
      placeholder: '제목, 필자, 태그',
      defaultValue: s === 'empty' ? '존재하지 않는 제목' : ''
    })), h('div', {
      className: 's3'
    }, h(Select, {
      label: '상태'
      ...
      label: '섹션'
    }, h('option', null, '전체'), SEC.map(x => h('option', {
      key: x
    }, x))))), h(Table, {
      caption: '9월 기사',
      columns: aCols(w < 834),
      rows: s === 'error' || s === 'loading' ? [] : rows,
      rowKey: r => r.id,
      loading: s === 'loading',
      error: s === 'error' ? '기사 목록을 불러오지 못했습니다. 네트워크를 확인하세요.' : undefined,
      emptyMessage: '검색 조건에 맞는 기사가 없습니다.',
      pagination: {
        pageSize: 6
      },
      minWidth: w < 834 ? 0 : 720
    }));
  }
  /* 04 detail */
  function Detail({
    ...
    return h(Shell, {
      ...
      href: 'screen.html?p=table'
    }, '기사'), h('span', null, 'DEW-2701')), s === 'error' ? h(F, null, Err('기사 DEW-2701을 찾을 수 없거나 권한이 없습니다.')) : h(F, null, h('header', {
      className: 'g12',
      style: {
        alignItems: 'end',
        borderBottom: 'var(--dew-rule-heavy)',
      ...
      className: 'dew-miss'
    }, '리드 문단이 아직 없습니다') : '오래된 동네의 서점들은 어떻게 저녁을 맞이하는가. 세 곳의 책방 주인과 보낸 가을 오후.')), h('div', {
      className: 's4 stack',
      style: {
        gap: 12
      }
      ...
      variant: 'secondary'
    }, '미리보기'), h(Button, null, '발행 요청')))), h('div', {
      className: 'g12'
    }, h('div', {
      className: 's8 stack',
      style: {
      ...
      className: 'dew-photo dew-photo--light',
      style: {
        aspectRatio: '3/2',
        alignItems: 'center',
        justifyContent: 'center'
      }
    }, h('span', null, '대표 사진 없음 · 업로드 필요')) : Photo('HERO 3:2', '3/2', 'mid'), h('div', {
      className: 'stack',
      style: {
        gap: 16,
        maxWidth: '66ch'
      }
    }, (L ? [1, 2, 3] : ['해가 짧아지면 골목의 서점들은 조금 일찍 불을 켠다. 첫 번째로 찾은 곳은 문을 연 지 삼 년이 된 작은 책방이다.', '주인은 매일 저녁 여섯 시에 추천 책 한 권을 창가에 올려 둔다. 그날 들어온 손님의 대화에서 고른 책이다.', '세 번째 서점에서는 오래된 극장 포스터가 벽 한 면을 채우고 있었다.']).map((p, i) => L ? h(Skeleton, {
      key: i,
      height: 18
    }) : h('p', {
      key: i
    ...
    }, [['필자', M ? null : '한지우'], ['사진', M ? null : '오하람'], ['섹션', '에세이'], ['분량', M ? null : '4,210자'], ['발행 예정', '2026-10-01'], ['태그', M ? null : '서점 · 골목 · 가을']].map(([k, v]) => h('div', {
      key: k,
      className: 'row',
      style: {
        justifyContent: 'space-between'
      ...
      className: 'dew-small'
    }, '두 번째 문단 사진 캡션 확인 필요. 서점 이름 표기 통일.'))))));
  }
  /* 05 settings */
  function Settings({
    s
    ...
    return h(Shell, {
      active: 'settings',
      state: s
    }, Head('SETTINGS', '매체 설정', '웹진 이름, 발행 주기, 알림을 관리합니다.'), s === 'success' && h('div', {
      className: 'banner ok',
      role: 'status'
    }, h('span', {
      className: 'ic'
    ...
    })), h('div', null, h('b', null, '설정을 저장했습니다'), h('div', {
      className: 'dew-small dew-muted'
    }, '다음 호부터 적용됩니다.'))), s === 'error' && h('div', {
      className: 'banner',
      role: 'alert'
    }, h('span', {
      className: 'ic'
      ...
      name: 'eva:alert-circle-outline'
    })), h('div', null, h('b', null, '저장하지 못했습니다'), h('div', {
      className: 'dew-small dew-muted'
    }, '표시된 항목을 확인하세요.'))), h('div', {
      className: 'g12'
    }, h('div', {
      ...
      label: '대표 이메일',
      defaultValue: s === 'error' ? 'desk@' : 'desk@dew.example',
      error: s === 'error' ? '올바른 이메일 형식이 아닙니다.' : undefined,
      disabled: s === 'saving'
    }), h(Textarea, {
      label: '소개',
      defaultValue: '도시의 작은 장면을 기록하는 에디토리얼 웹진.',
      description: '검색 결과와 공유 카드에 표시됩니다.',
      disabled: s === 'saving'
    }), h(Select, {
      label: '발행 주기',
      defaultValue: 'm',
      ...
      label: '발행 전날 편집자에게 리마인더 보내기',
      disabled: s === 'saving'
    }), h(Checkbox, {
      label: '주간 리포트를 이메일로 받기',
      defaultChecked: true,
      disabled: s === 'saving'
    }))), h('div', {
      className: 'row',
  ...
  /* 06 billing */
  const PLANS = [['READER', '무료', ['주 1회 뉴스레터', '공개 기사']], ['MEMBER', '₩6,900 / 월', ['전체 아카이브', '광고 없음', '종이판 할인 10%']], ['PATRON', '₩19,000 / 월', ['MEMBER 전부', '연 2회 종이판', '편집 모임 초대']]];
  const inv = [{
    id: 'INV-0931',
    d: '2026-09-01',
    p: 'MEMBER',
  ...
  function Billing({
    ...
    return h(Shell, {
      active: 'billing',
      state: s
    }, Head('SUBSCRIPTION', '구독', '현재 플랜과 결제 내역입니다.'), s === 'error' && Err('결제 정보를 가져오지 못했습니다. 카드 정보는 변경되지 않았습니다.'), h('div', {
      className: 'g12'
    }, PLANS.map(([n, p, f], i) => h('div', {
      key: n,
      className: 's4'
    }, L ? h(Skeleton, {
      height: 260
      ...
      className: 'dew-card',
      style: i === 1 && s !== 'empty' ? {
        borderTop: '3px solid var(--dew-action)'
      } : undefined,
      'aria-label': n + ' 플랜'
    }, h('div', {
      className: 'row',
      ...
      className: 'dew-overline'
    }, n), i === 1 && s !== 'empty' && h(Badge, {
      tone: 'info'
    }, '현재 플랜')), h('div', {
      style: {
        font: 'var(--dew-text-h2)'
      }
    }, p), h('ul', {
      className: 'list-rule',
      style: {
      ...
      variant: i === 1 && s !== 'empty' ? 'secondary' : i === 2 ? 'primary' : 'secondary',
      disabled: s === 'error'
    }, i === 1 && s !== 'empty' ? '플랜 관리' : '선택'))))), h(Table, {
      caption: '결제 내역',
      columns: [{
        id: 'id',
        header: '청구서',
        ...
        header: '금액',
        align: 'right',
        cell: r => r.a == null ? miss(null) : '₩' + r.a.toLocaleString('ko-KR')
      }, {
        id: 's',
        header: '상태',
        cell: r => h(Badge, {
          tone: r.s === '환불' ? 'neutral' : 'success'
        }, r.s)
      }],
      rows: s === 'empty' || s === 'error' ? [] : inv,
      rowKey: r => r.id,
      loading: L,
      error: s === 'error' ? '결제 내역을 불러오지 못했습니다.' : undefined,
      emptyMessage: '아직 결제 내역이 없습니다. 무료 READER 플랜 이용 중입니다.',
      minWidth: 520
    }));
  }
  /* 07 chat */
  const MSG = [['u', '이번 호 특집 제목 후보를 세 개 제안해 줘. 골목 서점이 주제야.'], ['a', '세 가지 방향으로 제안합니다.\n1. 골목 끝, 불 켜진 서점\n2. 저녁 여섯 시의 책방\n3. 작은 서점이 도시를 읽는 법'], ['u', '2번으로 리드 문단 초안도 부탁해.']];
  function Chat({
    s
  }) {
    const msgs = s === 'empty' ? [] : MSG;
    return h(Shell, {
      active: 'chat',
      state: s
    }, Head('EDITORIAL ASSISTANT', '어시스턴트', '제목·리드·교정 초안을 요청하세요. 결과는 편집자가 검토합니다.'), h('div', {
      className: 'g12'
    }, h('section', {
      className: 's8 stack',
      style: {
      ...
      'aria-label': '대화'
    }, s === 'empty' ? Empty('?', '무엇을 도와드릴까요?', '예: “이번 호 특집 제목 후보 3개”, “리드 문단 교정”', h(F, null, ['제목 후보', '리드 초안', '맞춤법 교정'].map(x => h(Button, {
      key: x,
      variant: 'secondary',
      size: 'sm'
    }, x)))) : h('ol', {
      ...
      className: 'dew-overline',
      style: {
        color: r === 'a' ? 'var(--dew-action)' : undefined
      }
    }, r === 'a' ? 'ASSISTANT' : '편집자'), h('p', {
      style: {
        whiteSpace: 'pre-line',
        font: r === 'a' ? 'var(--dew-text-lead)' : 'var(--dew-text-body)',
        color: 'var(--dew-fg)'
      }
    }, t))), s === 'streaming' && h('li', {
      style: {
      ...
      style: {
        font: 'var(--dew-text-lead)'
      }
    }, '해가 짧아지면 골목의 서점들은 조금 일찍 불을 켠다▍'), h('span', {
      className: 'dew-caption'
    }, '작성 중…'))), s === 'error' && h('li', {
      style: {
        padding: '20px 0'
    ...
    }, h('b', null, '응답을 생성하지 못했습니다'), h('div', null, h(Button, {
      variant: 'secondary',
      size: 'sm'
    }, '다시 생성'))))))), h('form', {
      className: 'stack',
    ...
    }, ['DEW 표기 원칙 v3', '가을호 기획안', '서점 인터뷰 녹취'].map(x => h('li', {
      key: x,
      className: 'row'
    }, h(Icon, {
  ...
  /* 08 builder */
  const BLOCKS = [['hero', '커버 사진', 's8', 260], ['title', '특집 제목', 's4', 260], ['text', '리드 문단', 's4', 140], ['quote', '인용', 's4', 140], ['grid', '사진 3단', 's4', 140]];
  function Builder({
    s
  }) {
    const sel = s === 'selected' || s === 'dragging' ? 'title' : null;
    const blocks = s === 'empty' ? [] : BLOCKS;
    return h(Shell, {
      active: 'builder',
      state: s
    }, Head('LAYOUT BUILDER', '지면 빌더', '블록을 12단 격자에 배치해 특집 지면을 구성합니다.', h(F, null, h(Button, {
      variant: 'secondary'
    }, '미리보기'), h(Button, {
      disabled: s === 'empty'
    }, '지면 저장'))), h('div', {
    ...
    }, 'BLOCKS'), ['커버 사진', '제목', '본문', '인용', '사진 그리드', '구분선'].map(b => h('button', {
      key: b,
      type: 'button',
      className: 'dew-button dew-button--secondary dew-button--md',
      style: {
        justifyContent: 'flex-start'
      }
    }, h('span', null, h(Icon, {
      name: 'solar:widget-add-bold',
      size: 16
    }), b)))), h('section', {
      className: 's6',
      style: {
        border: 'var(--dew-rule-dash)',
        padding: 16,
        minHeight: 420,
        background: s === 'dragging' ? 'var(--dew-surface-alt)' : undefined
      },
      'aria-label': '캔버스'
    }, s === 'empty' ? Empty('+', '빈 지면', '왼쪽 블록을 끌어 놓거나 템플릿으로 시작하세요.', h(Button, {
      variant: 'secondary'
    }, '템플릿에서 시작')) : h('div', {
      className: 'g12',
      style: {
    ...
    }, blocks.map(([k, l, sp, ht]) => h('div', {
      key: k,
      className: sp,
      style: {
        height: ht,
        border: sel === k ? '2px solid var(--dew-black)' : '1px solid var(--dew-line)',
        background: k === 'hero' ? 'var(--dew-grey-200)' : 'var(--dew-surface)',
        padding: 12,
        display: 'flex',
        flexDirection: 'column',
        justifyContent: 'space-between',
        opacity: s === 'dragging' && sel === k ? .4 : 1
      }
    }, h('span', {
      className: 'dew-overline'
    }, l), k === 'title' && h('span', {
    ...
    }, '저녁 여섯 시의 책방'))), s === 'dragging' && h('div', {
      className: 's12',
      style: {
        height: 48,
        border: '2px solid var(--dew-action)',
        display: 'grid',
        placeItems: 'center'
      },
      className: 's12 dew-overline'
    }, '여기에 놓기'))), h('aside', {
      className: 's3 stack',
      'aria-label': '속성'
    }, h('div', {
    ...
    }, 'INSPECTOR'), sel ? h(F, null, h(TextField, {
      label: '제목 텍스트',
      defaultValue: '저녁 여섯 시의 책방'
    }), h(Select, {
      label: '서체',
      defaultValue: 'd'
    }, h('option', {
      value: 'd'
    }, 'Display serif'), h('option', {
      value: 's'
    }, 'Sans')), h(Select, {
      label: '너비',
      defaultValue: '4'
  ...
  function Modal({
    ...
    const d = s === 'dialog' ? h(Dialog, {
      inline: true,
      title: '기사 공유 설정',
      description: '외부 공유 카드에 표시될 정보를 확인하세요.',
      footer: h(F, null, h(Button, {
        variant: 'secondary'
      }, '취소'), h(Button, null, '저장'))
    }, h('div', {
      ...
      label: '공유 제목',
      defaultValue: '골목 끝, 불 켜진 서점'
    }), h(Textarea, {
      label: '요약',
      rows: 3,
      defaultValue: '세 곳의 책방 주인과 보낸 가을 오후.'
    }))) : h(AlertDialog, {
      inline: true,
      danger: true,
      previewState: s === 'pending' ? 'pending' : s === 'error' ? 'error' : undefined,
      title: '기사를 삭제할까요?',
      description: '“골목 끝, 불 켜진 서점”과 사진 12장이 함께 삭제되며 복구할 수 없습니다.',
      confirmLabel: '삭제',
      onConfirm() {}
    });
    return h(Shell, {
  ...
  function EmptyP({
    ...
    const m = {
      'first-run': ['01', 'DEW 편집국에 오신 것을 환영합니다', '첫 호를 만들고 필자를 초대하면 이 지면이 편집국 대시보드로 바뀝니다.', h(F, null, h(Button, null, '첫 호 만들기'), h(Button, {
        variant: 'text'
      }, '가이드 읽기'))],
      'no-results': ['0', '“극장 포스터”에 맞는 기사가 없습니다', '철자를 확인하거나 필터를 해제하세요. 보관된 기사는 검색되지 않습니다.', h(Button, {
        variant: 'secondary'
      }, '필터 해제')],
      'no-access': ['—', '이 지면을 볼 권한이 없습니다', '구독 관리는 편집장과 관리자만 볼 수 있습니다. 권한이 필요하면 편집장에게 요청하세요.', h(Button, {
        variant: 'secondary'
      }, '권한 요청')]
    }[s] || [];
    return h(Shell, {
      active: s === 'no-results' ? 'table' : s === 'no-access' ? 'billing' : 'dashboard',
      state: s
    }, s === 'no-results' && h('div', {
      style: {
        maxWidth: 480
      ...
      className: 's7'
    }, Empty(...m)), s === 'first-run' && h('div', {
      className: 's5 dp-hide-sm'
    }, Photo('WELCOME 4:5', '4/5', 'light'))));
  }
  const P = {
    dashboard: [Dashboard, ['default', 'loading', 'empty', 'error']],
    analytics: [Analytics, ['default', 'loading', 'empty', 'error']],
    table: [TablePage, ['default', 'loading', 'empty', 'error', 'long-text']],
    detail: [Detail, ['default', 'loading', 'missing-data', 'error']],
    settings: [Settings, ['default', 'saving', 'error', 'success']],
    billing: [Billing, ['default', 'loading', 'error', 'empty']],
    chat: [Chat, ['default', 'streaming', 'empty', 'error']],
    builder: [Builder, ['default', 'selected', 'dragging', 'empty']],
    modal: [Modal, ['dialog', 'confirm', 'pending', 'error']],
    empty: [EmptyP, ['first-run', 'no-results', 'no-access']]
  };
  window.DEW_PATTERNS = Object.fromEntries(Object.entries(P).map(([k, v]) => [k, v[1]]));
  window.DEW_mountPattern = function (root, p, s) {
    const e = P[p] || P.dashboard;
    const st = e[1].includes(s) ? s : e[1][0];
    ReactDOM.createRoot(root).render(h(e[0], {
      s: st
    }));
    return {
      p: P[p] ? p : 'dashboard',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/patterns.js", error: String((e && e.message) || e) }); }
...
(function () {
  ...
  const box = (el, w = 220) => h('div', {
    style: {
      width: w,
      maxWidth: '100%',
      border: '1px dashed var(--dew-line-mid)',
      padding: 8,
      overflow: 'hidden'
    }
  }, el);
  ...
  S.Button = {
    ...
    description: 'variant·size·loading·disabled가 실제 props. DEW 시각: 각진 0 radius, 빨강은 주 행동 1개에만, 보조는 검정 선.',
    meta: ['packages/ui/src/index.tsx', 'variant primary|secondary|danger|text', 'size sm 32 · md 40 · lg 48 (derived)', 'radius 0 (derived)', 'focus 2px outline + 2px offset'],
    sections: [{
      title: 'Variant',
      cases: [['primary', 'variant="primary" · red CTA', '구독하기'], ['secondary', 'variant="secondary" · black rule', '취소'], ['danger', 'variant="danger"', '삭제'], ['text', 'variant="text" · underline', '기사 전체 보기']].map(([v, l, t]) => ({
        id: v,
        label: l,
        el: h(Button, {
          variant: v
      ...
      title: 'Size',
      cases: ['sm', 'md', 'lg'].map((s, i) => ({
        id: 'size-' + s,
        label: `size="${s}" · ${[32, 40, 48][i]}px`,
      ...
      title: 'State',
      note: 'hover/pressed/focus는 data-preview-state로 고정 표시(카드 전용). 실제는 :hover/:active/:focus-visible',
      cases: [{
        id: 'default',
        label: 'default',
        el: h(F, null, h(Button, null, '구독하기'), h(Button, {
          variant: 'secondary'
        }, '취소'))
      }, {
        id: 'hover',
        label: 'hover · primary red-600 / secondary 반전',
        el: h(F, null, h(Button, {
        ...
        id: 'pressed',
        label: 'pressed · red-700 / grey-800',
        el: h(F, null, h(Button, {
        ...
        id: 'focus',
        label: 'focus-visible · 2px/2px black',
        el: h(F, null, h(Button, {
        ...
        id: 'disabled',
        label: 'disabled · grey-100 / fg-disabled',
        el: h(F, null, h(Button, {
          disabled: true
        }, '구독하기'), h(Button, {
          disabled: true,
      ...
      cases: [{
        ...
        id: 'long-label',
        label: '긴 문구 · nowrap(소스) → 부모가 폭 제약 시 잘림',
        el: box(h(Button, null, '이번 호 특집 기사 전체를 PDF로 내려받기'))
      }]
    }, {
      title: 'Design-only',
      note: '코드에 없음. 제품에서는 오른쪽 대응 props 사용',
      cases: [{
        id: 'd-arrow',
        tag: 'design-only',
        label: 'Editorial arrow link → variant="text" + Icon',
        el: h('button', {
          type: 'button',
          className: 'dew-button dew-button--text dew-button--md',
          style: {
            textDecoration: 'none',
            borderBottom: '1px solid currentColor',
            paddingInline: 0
          }
        }, h('span', null, 'READ STORY ', h(Icon, {
        ...
        id: 'd-inverse',
        tag: 'design-only',
        label: 'Inverse on photo → 대응 없음 (secondary 사용)',
        demoStyle: {
          background: 'var(--dew-grey-800)'
        },
        el: h('button', {
          type: 'button',
          className: 'dew-button dew-button--md',
          style: {
            background: 'transparent',
            borderColor: '#fff',
            color: '#fff'
          }
        }, h('span', null, 'VIEW GALLERY'))
      }]
    }],
  ...
  const fieldCases = (C, extra = {}) => [{
    ...
    el: W(300, h(C, {
      label: '슬러그',
      description: '영문 소문자와 하이픈만 사용합니다.',
      defaultValue: 'autumn-bookshops',
      ...extra
    }))
  }, {
    id: 'required',
    ...
    id: 'error',
    label: 'error → aria-invalid + 빨강 하단선',
    el: W(300, h(C, {
      label: '이메일',
    ...
    el: W(300, h(C, {
      label: '발행 ID',
      disabled: true,
      defaultValue: 'DEW-2026-09',
      ...extra
    }))
  }, {
    id: 'long',
    label: '긴 문구 · 라벨/값/에러 줄바꿈',
    el: W(260, h(C, {
      label: '이번 호 특집 기사 대표 제목 (검색 결과와 공유 카드에 함께 쓰임)',
      defaultValue: LONG,
      error: '제목은 60자 이내로 줄여 주세요. 공유 카드에서 잘릴 수 있습니다.',
      ...extra
    }))
  }];
  S.TextField = {
    ...
    description: 'label·description·error·required·disabled + 네이티브 input 속성. 라벨은 overline 대문자, 필드는 0 radius 1px 회색선.',
    meta: ['packages/ui/src/index.tsx', 'height 40 (md)', 'error = description 대체', 'radius 0 (derived)'],
    sections: [{
      title: 'Field states',
      cases: fieldCases(TextField)
    }, {
      title: 'Native type',
      cases: [{
        id: 'search',
        tag: 'native',
        label: 'type="search"',
        el: W(300, h(TextField, {
          label: '검색',
          type: 'search',
          placeholder: '기사, 필자, 태그'
        }))
      }, {
        id: 'number',
        tag: 'native',
  ...
  S.Textarea = {
    name: 'Textarea',
    group: 'Components · Inputs',
    description: 'TextField와 같은 field shell, rows 기본 4, resize vertical.',
    meta: ['packages/ui/src/index.tsx', 'min-height 112', 'line-height 1.65'],
    sections: [{
      title: 'States',
      cases: [{
        id: 'default',
        ...
        el: W(320, h(Textarea, {
          label: '리드 문단',
          'data-preview-state': 'focus',
          defaultValue: '가을 오후, 골목 끝 서점에 불이 켜졌다.'
        }))
      }, {
        id: 'error',
        label: 'error',
  ...
  S.Select = {
    name: 'Select',
    group: 'Components · Inputs',
    description: '네이티브 select + field shell. 1.5px 검정 chevron. 옵션 목록은 OS 기본 렌더.',
    meta: ['packages/ui/src/index.tsx', 'native <select>', 'padding-right 40'],
    sections: [{
      title: 'States',
      cases: [{
        id: 'default',
    ...
    notInSource: ['검색형/다중 선택 combobox 없음 — 네이티브 select만']
  };
  S.Checkbox = {
    name: 'Checkbox',
    group: 'Components · Selection',
    description: 'label + 네이티브 checkbox. 18px 정사각, 체크 시 검정 채움.',
    meta: ['packages/ui/src/index.tsx', '18×18 · radius 0', 'checked = black'],
    sections: [{
      title: 'States',
      cases: [{
        id: 'unchecked',
        ...
        label: '긴 문구 · 줄바꿈',
        el: W(260, h(Checkbox, {
          label: '개인정보 수집·이용과 마케팅 정보 수신, 제3자 제공 동의 내용을 모두 확인했습니다'
        }))
      }]
    }],
    notInSource: ['indeterminate 상태 없음', 'error prop 없음']
  };
  S.Switch = {
    name: 'Switch',
    group: 'Components · Selection',
    description: 'role="switch" 체크박스. 사각 트랙 40×22, 켜짐은 검정 반전.',
    meta: ['packages/ui/src/index.tsx', 'track 40×22 · knob 14', 'motion base 180ms'],
    sections: [{
      title: 'States',
      cases: [{
        id: 'off',
        ...
        label: '긴 문구',
        el: W(260, h(Switch, {
          label: '새 댓글이 달리면 필자와 담당 편집자에게 이메일로 즉시 알림 보내기'
        }))
      }]
    }]
  };
  S.Badge = {
    ...
    description: 'tone 5종. 사각, overline 대문자. 빨강은 error만 — 섹션 라벨 빨강은 design-only.',
    meta: ['packages/ui/src/index.tsx', 'tone neutral|success|warning|error|info'],
    sections: [{
      title: 'Tone',
      cases: [['neutral', '초안'], ['success', '발행됨'], ['warning', '검토 중'], ['error', '반려'], ['info', '특집']].map(([t, l]) => ({
        id: t,
        label: `tone="${t}"`,
        el: h(Badge, {
          tone: t
      ...
      cases: [{
        ...
        id: 'long',
        label: '긴 문구 · 줄바꿈',
        el: W(180, h(Badge, null, '2026 가을호 특집 연재 · 골목 서점'))
      }]
    }, {
      title: 'Design-only',
      cases: [{
        id: 'd-section',
        tag: 'design-only',
        label: 'Section label (red overline) → 대응 없음',
        el: h('span', {
          className: 'dew-overline dew-overline--red'
        }, 'FEATURE — 04')
      }, {
        id: 'd-number',
        tag: 'design-only',
        label: 'Issue number → tone="info"',
        el: h('span', {
          style: {
            font: '400 22px/1 var(--dew-font-display)',
  ...
  S.Card = {
    name: 'Card',
    group: 'Components · Display',
    description: 'title(h2 serif)·footer·children. 모서리 0, 상단 검정 1px + 나머지 hair선.',
    meta: ['packages/ui/src/index.tsx', 'padding 24 · radius 0', 'title → aria-labelledby'],
    sections: [{
      title: 'Composition',
      min: 320,
      cases: [{
        id: 'title-footer',
        label: 'title + children + footer',
        el: W(340, h(Card, {
          title: '이번 주 발행',
          footer: '9월 25일 업데이트'
        }, h('div', {
        ...
        id: 'body-only',
        label: 'children only',
        el: W(340, h(Card, null, h('p', null, '제목 없는 카드는 aria-labelledby를 직접 전달하세요.')))
      }, {
        id: 'loading',
        tag: 'composition',
        label: 'loading · Skeleton 조합',
        el: W(340, h(Card, {
          title: '이번 주 발행',
          'aria-busy': 'true'
        }, h(Skeleton, {
        ...
        el: W(340, h(Card, {
          ...
          className: 'dew-error dew-small'
        }, '불러오지 못했습니다.'), h('div', null, h(Button, {
          variant: 'secondary',
          size: 'sm'
        }, '다시 시도'))))
      }, {
        ...
        id: 'd-story',
        tag: 'design-only',
        label: 'Story card (photo) → Card + 이미지 children',
        el: W(300, h('article', {
          className: 'story'
        }, h('div', {
          className: 'dew-photo',
        ...
        }, h('span', null, 'PHOTO 4:5')), h('div', {
          className: 'dew-overline dew-overline--red'
        }, 'ESSAY'), h('h3', null, '골목 끝, 불 켜진 서점'), h('div', {
          className: 'dew-byline'
        }, h('span', null, '글 한지우'), h('span', null, '6분'))))
      }]
    }]
  };
  S.Skeleton = {
    ...
    description: 'aria-hidden 로딩 자리표시. 회색 shimmer, reduced-motion에서 정지.',
    meta: ['packages/ui/src/index.tsx', 'width · height · circle', 'shimmer 1.4s · reduced → none'],
    sections: [{
      title: 'Shapes',
      cases: [{
        id: 'line',
        label: 'line · 100% × 20',
        el: W(260, h(Skeleton, null))
      }, {
        id: 'sized',
        label: 'width/height',
        el: h(F, null, h(Skeleton, {
          width: 120,
          height: 32
        }), h(Skeleton, {
          width: 64,
        ...
        id: 'reduced',
        tag: 'preview-only',
        label: 'prefers-reduced-motion → animation none',
        el: W(260, h(Skeleton, {
          style: {
            animation: 'none'
          }
  ...
  S.Icon = {
    name: 'Icon',
    group: 'Components · Display',
    description: '실제 SVG 97개 (Eva/Solar) · currentColor. 없는 이름은 null 반환. DEW에서 아이콘은 보조 — 타이포가 주.',
    meta: ['packages/ui/src/index.tsx', 'size 16 / 20 / 24', 'label → role=img'],
    sections: [{
      title: 'Size & color',
      cases: [{
        id: 's16',
        label: 'size=16',
        el: icons.map(n => h(Icon, {
          key: n,
          name: n,
          size: 16
        }))
        ...
        id: 'color',
        label: 'currentColor · black / grey / red',
        el: h(F, null, h('span', {
          style: {
            color: 'var(--dew-fg)'
          }
        ...
        id: 'unresolved',
        label: '누락 이름 → null (렌더 없음)',
        el: h('span', {
          className: 'dew-caption'
        }, 'solar:gem-bold → ', h(Icon, {
          name: 'solar:gem-bold'
        }) || 'null')
      }]
    }]
  ...
  S.Dialog = {
    ...
    description: '모달. 검정 1px 테두리, 제목 serif h2 + 하단 검정 선. 카드에서는 inline 무대로 고정 표시.',
    meta: ['packages/ui/src/composites.tsx', 'size sm 480 · md 640 · lg 880', 'overlay black 56%', 'focus trap · Esc'],
    sections: [{
      title: 'Size',
      min: 560,
      ...
      cases: [{
        ...
        el: h('div', {
          ...
          inline: true,
          title: LONG,
          footer: h(Button, null, '확인')
        }, h('p', null, (LONG + '. ').repeat(6))))
      }, {
        id: 'live',
        label: 'live · trigger 클릭 → 포털',
        el: h(Dialog, {
          trigger: h(Button, {
            variant: 'secondary'
          }, '대화상자 열기'),
          title: '발행 예약',
          description: '10월 1일 09:00에 발행됩니다.',
          footer: h(Button, null, '확인')
        })
      }]
    }],
    notInSource: ['inline prop은 미리보기 전용 (소스는 Radix portal)']
  };
  const items = [{
    id: 'open',
    label: '기사 열기'
  ...
  S.Menu = {
    name: 'Menu',
    group: 'Components · Overlay',
    description: '드롭다운 메뉴. 강조 행은 검정 반전, danger는 빨강 반전.',
    meta: ['packages/ui/src/composites.tsx', 'items: id·label·onSelect·disabled·danger·separatorBefore', 'keyboard ↑↓ Home End Esc'],
    sections: [{
      title: 'States',
      cases: [{
        id: 'default',
        tag: 'preview-only',
        label: 'inline · highlighted 첫 항목',
        el: h(Menu, {
          inline: true,
          label: '기사 작업',
          items,
  ...
  S.Table = {
    ...
    description: 'caption · columns · rows · sort · pagination · virtualization · loading · error · empty. 상단 3px 검정 굵은선, 헤더 overline, 행 hair선.',
    meta: ['packages/ui/src/table.tsx', 'sort aria-sort', 'pagination pageSize', 'virtualization height/rowHeight'],
    sections: [{
      title: 'Data states',
      min: 560,
      cases: [{
        id: 'default',
        wide: true,
        label: 'default · defaultSort 조회 ↓ · 누락(—, 미지정) · 긴 제목',
        el: h('div', {
          style: {
            width: '100%'
          }
        ...
        id: 'focus',
        tag: 'preview-only',
        label: 'sort button focus-visible',
        el: h('button', {
          type: 'button',
          className: 'dew-table-sort',
          'data-preview-state': 'focus',
          style: {
            font: 'var(--dew-text-overline)',
            letterSpacing: '.12em'
          }
        }, '제목 ↕')
      }, {
        id: 'virtual',
        wide: true,
        label: 'virtualization · 120행 · height 280',
        el: h('div', {
          style: {
            width: '100%'
          }
  ...
  S.Pagination = {
    name: 'Pagination',
    group: 'Components · Data',
    description: '처음·이전·현재/전체·다음·마지막. 각진 40px 버튼, hover 검정 반전.',
    meta: ['packages/ui/src/table.tsx', 'page · pageCount · onPageChange · disabled'],
    sections: [{
      title: 'States',
      min: 340,
      cases: [{
  ...
  S.Toast = {
    name: 'Toast',
    group: 'Components · Feedback',
    description: 'ToastProvider + useToast().notify. 각진 검정 테두리, 아이콘 사각 32. 최대 3개 표시.',
    meta: ['packages/ui/src/toast.tsx', 'tone info|success|warning|error', 'duration 5000 · 0=유지', 'viewport 380 · bottom-right'],
    sections: [{
      title: 'Tone',
      min: 380,
      cases: [['info', '편집 회의가 10분 후 시작됩니다'], ['success', '기사가 발행되었습니다'], ['warning', '사진 저작권 확인이 필요합니다'], ['error', '저장하지 못했습니다']].map(([t, l]) => ({
        id: t,
        tag: 'preview-only',
        label: `tone="${t}" · ToastView`,
        el: ul(h(TV, {
          tone: t,
          title: l
        }))
      ...
      cases: [{
        ...
        id: 'live',
        label: 'live · ToastProvider',
        el: h(D.ToastProvider, null, h(LiveToast))
      }]
    }],
    notInSource: ['ToastView는 미리보기용 노출 — 제품은 useToast().notify만 사용']
  };
  S.AlertDialog = {
    name: 'AlertDialog',
    group: 'Components · Overlay',
    description: '확인이 필요한 파괴적 작업. 비동기 onConfirm pending·error 상태, 취소 버튼 초기 포커스.',
    meta: ['packages/ui/src/alert-dialog.tsx', 'danger → variant danger', 'pending → loading', 'error → role=alert'],
    sections: [{
      title: 'States',
      min: 520,
      cases: [{
        ...
        el: h('div', {
          ...
          inline: true,
          title: '발행할까요?',
          description: '구독자 12,480명에게 뉴스레터가 함께 발송됩니다.',
          confirmLabel: '발행',
          onConfirm() {}
        }))
      }, {
        ...
        el: h('div', {
          ...
          danger: true,
          title: '기사를 삭제할까요?',
          description: '삭제한 기사는 복구할 수 없습니다.',
          confirmLabel: '삭제',
          onConfirm() {}
        }))
      }, {
        ...
        el: h(AlertDialog, {
          ...
          description: '삭제한 기사는 복구할 수 없습니다.',
          confirmLabel: '삭제',
          onConfirm: () => new Promise((_, rej) => setTimeout(() => rej(new Error('x')), 900))
        })
      }]
    }]
  };
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "dew/lib/specs.js", error: String((e && e.message) || e) }); }
