...
const server=new Server({name:'iak-design-system',version:'0.9.1'},{capabilities:{tools:{}}});
...
server.setRequestHandler(CallToolRequestSchema,async req=>{
 try {
  ...
  let result;
  switch(name){
   case 'health_check':result={version:'0.9.1',components:components.length,tokens:Object.keys(catalog.tokens).length,icons:Object.keys(icons.icons).length,transport:'stdio',readOnly:true};break;
   ...
   case 'getting_started':result={docs:'https://sugun8119-ops.github.io/iak-design-system/developer/',uiInstall:'npm install https://sugun8119-ops.github.io/iak-design-system/developer/releases/iak-design-ui-0.9.1.tgz',status:'Preview tarball, not npm registry publication',comparison};break;
  }
